...
//      Too many to count
//
template< template< typename... > typename FirstType, template< typename... > typename SecondType, template< typename... > typename... Types >
class CompareTemplateTemplateTypes : public IntegralConstant< Boolean, CompareTemplateTemplateTypes< FirstType, SecondType >::Result() && CompareTemplateTemplateTypes< SecondType, Types... >::Result() >
{
private :


    // Disable all default generated methods - constructor, destructor, copy constructor, assignment operator, move constructor and move assignment operator
    NoInstances( CompareTemplateTemplateTypes );


};  //  Class CompareTemplateTemplateTypes
...
//      Too many to count
//
template< template< typename... > typename FirstType, template< typename... > typename SecondType >
class CompareTemplateTemplateTypes< FirstType, SecondType > : public IntegralConstant< Boolean, false >
{
private :
...
class CompareTemplateTemplateTypes< Type, Type > : public IntegralConstant< Boolean, true >
{
private :

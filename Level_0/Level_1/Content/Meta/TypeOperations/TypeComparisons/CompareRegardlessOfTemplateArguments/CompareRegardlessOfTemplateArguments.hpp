...
class CompareRegardlessOfTemplateArguments : public IntegralConstant< Boolean, CompareRegardlessOfTemplateArguments< FirstType, SecondType >::Result() && CompareRegardlessOfTemplateArguments< SecondType, Types... >::Result() >
{
private :


    // Disable all default generated methods - constructor, destructor, copy constructor, assignment operator, move constructor and move assignment operator
    NoInstances( CompareRegardlessOfTemplateArguments );


};  //  Class CompareRegardlessOfTemplateArguments
...
class CompareRegardlessOfTemplateArguments< FirstType, SecondType > : public IntegralConstant< Boolean, false >
{
private :
...
// ************************************************************************************************************************************************************************** //
//                                                                                                                                                                            //
// ****************************************   TEMPLATE SPECIALIZATION IMPLEMENTATION - Only two template arguments, and the same type   ************************************* //
//                                                                                                                                                                            //      
// ************************************************************************************************************************************************************************** //
...
//  Purpose :
//
//      This is a template specialization for two template types, that are the same types. The result method will return true
//
//  Description :
//
//      1. Encapsulation means that the user is only allowed to access certain parts of the object. Encapsulation is acheived in C++ by providing 3 keywords :
...
//      Too many to count
//
template< template< typename... > typename TemplatedType, typename... FirstTypeTemplateArgumentPack, typename... SecondTypeTemplateArgumentPack >
class CompareRegardlessOfTemplateArguments< TemplatedType< FirstTypeTemplateArgumentPack... >, TemplatedType< SecondTypeTemplateArgumentPack... > > : public IntegralConstant< Boolean, true >
{
private :

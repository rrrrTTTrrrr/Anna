...
class CompareTypesRegardlessOfAttributes : public IntegralConstant< Boolean, CompareTypes< typename RemoveAttributes< FirstType >::Type, typename RemoveAttributes< SecondType >::Type >::Result && CompareTypesRegardlessOfAttributes< SecondType, Types... >::Result >
{
private :


    // Disable all default generated methods - constructor, destructor, copy constructor, assignment operator, move constructor and move assignment operator
    NoInstances( CompareTypesRegardlessOfAttributes );


};  //  Class CompareTypesRegardlessOfAttributes
...
class CompareTypesRegardlessOfAttributes< FirstType, SecondType > : public IntegralConstant< Boolean, CompareTypes< typename RemoveAttributes< FirstType >::Type, typename RemoveAttributes< SecondType >::Type >::Result >
{
private :

...
class DoesQualifiersExist : public IntegralConstant< Boolean, IsConstant< AnyType >::Result() == true || IsVolatile< AnyType >::Result() == true || IsPointer< AnyType >::Result() == true || IsReference< AnyType >::Result() == true >
{
private:


    // Disable all default generated methods - constructor, destructor, copy constructor, assignment operator, move constructor and move assignment operator
    NoInstances( DoesQualifiersExist );


};  //  Class DoesQualifiersExist

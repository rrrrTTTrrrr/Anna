...
class ConstantMethodPointerBoundToInstance
{};
...
//		The difference between a function and method, is that method is a function that belongs to an object. This object also stores an instance 
//		of the object that the method belongs to, to operate on
//
//  Description :
//
//		1. This object contains an instance of the object "State" to allow each instance of this object to have a defined state
...
class ConstantMethodPointerBoundToInstance< ObjectType, ReturnType ( ArgumentTypes... ) > : public BaseInvokableObject< ReturnType, ArgumentTypes... >, public InvokableObjectInterface< ReturnType, ArgumentTypes... >
{
public:


	// Create a type definition for this object
	using SelfType = ConstantMethodPointerBoundToInstance< ObjectType, ReturnType ( ArgumentTypes... ) >;
	...
	//		They will come
	//
	inline ConstantMethodPointerBoundToInstance();
	...
	//			2. constantMethodRawPointer - the memory address of the method with the 'const' qualifier to call
	//
	//		Information returned to the user :
	//
	//			NONE
	...
	//		They will come
	//
	inline ConstantMethodPointerBoundToInstance( const ObjectType& instance, ConstantMethodPointerType const constantMethodRawPointer );
	...
	//		They will come
	//
	inline ConstantMethodPointerBoundToInstance( const SelfType& other );
	...
	//		5. Reset
	//
	ObjectInfrastructure_ForInheritance( ConstantMethodPointerBoundToInstance )
	...
	//		They will come
	//
	virtual ~ConstantMethodPointerBoundToInstance() = default;
...
protected:
	...
	const ObjectType* member_instance;
...
//		method is a function that belongs to an object. This object also stores an instance of the object that the method belongs to, to operate on
//
//  Description :
//
//		1. This object contains an instance of the object "State" to allow each instance of this object to have a defined state
...
class ConstantMethodPointerBoundToInstance< ObjectType, ReturnType () > : public BaseInvokableObject< ReturnType >, public InvokableObjectInterface< ReturnType >
{
public:


	// Create a type definition for this object
	using SelfType = ConstantMethodPointerBoundToInstance< ObjectType, ReturnType () >;
	...
	//
	//			1. instance - the memory address of an instance of the object that the method belongs to
	//			2. constantmethodPointer - the memory address of the method with the 'const' qualifier to call
	//
	//		Information returned to the user :
	//
	//			NONE
	...
	//		They will come
	//
	inline ConstantMethodPointerBoundToInstance( const ObjectType& instance, ConstantMethodPointerType const constantmethodPointer );
	...
	DEBUG_TOOL(
		...
		//		It says there are no problems, which is even scarier, did I just wrote a working code??
		//
		static inline void UnitTest() __attribute__ (( __unused__ )) { ConstantMethodPointerBoundToInstance< Error::Assert< Error::Exception > COMMA UnsignedInteger64bits ( UnsignedInteger32bits ) >::UnitTest(); }

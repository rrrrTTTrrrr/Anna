...
//		Too many to count
//
class Vertex_2D NotForInheritance
{
public:


	// Create a type definition for this object
	using SelfType = Vertex_2D;
	...
	//		User information needed :
	//
	//			firstDimensionPosition - the value of the first dimension position
	//			secondDimensionPosition - the value of the second dimension position
	//
	//		Information returned to the user :
	//
	//			NONE
	...
	//		They will come
	//
	explicit inline Vertex_2D( const FloatingPoint64bits firstDimensionPosition, const FloatingPoint64bits secondDimensionPosition );
	...
	//		They will come
	//
	inline Vertex_2D( const SelfType& other );
	...
	//		5. Reset
	//
	ObjectInfrastructure( Vertex_2D )
	...
	//		They will come
	//
	inline ~Vertex_2D() = default;


	// This part will contain all the get and set methods for the members of the object :


	GetByValue_Creator( /* GetMethodName */ FirstDimensionPosition, /* MemberName */ member_firstDimensionPosition, /* MemberType */ FloatingPoint64bits )
	SetByValue_Creator( /* SetMethodName */ SetFirstDimensionPosition, /* MemberName */ member_firstDimensionPosition, /* MemberType */ FloatingPoint64bits )

	GetByValue_Creator( /* GetMethodName */ SecondDimensionPosition, /* MemberName */ member_secondDimensionPosition, /* MemberType */ FloatingPoint64bits )
	SetByValue_Creator( /* SetMethodName */ SetSecondDimensionPosition, /* MemberName */ member_secondDimensionPosition, /* MemberType */ FloatingPoint64bits )
...
private:
	...
	// This object will store the position of the vertex in the first dimension
	FloatingPoint64bits member_firstDimensionPosition;

	// This object will store the position of the vertex in the second dimension
	FloatingPoint64bits member_secondDimensionPosition;

...
class TemplateObject NotForInheritance
{
public:


	// Create a type definition for this object
	using SelfType = TemplateObject< AnyType >;
	...
	//		They will come
	//
	explicit inline TemplateObject();
	...
	//		They will come
	//
	explicit inline TemplateObject( UnsignedInteger64bits size, AnyType value = AnyType() );
	...
	//		They will come
	//
	inline TemplateObject( const SelfType& other );
	...
	//		They will come
	//
	inline TemplateObject( TemplateObject&& other );

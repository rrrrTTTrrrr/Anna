...
public:
	...
	//			3. key - a key to allow using the object in containers that required identification method
	//
	//		Information returned to the user :
	//
	//			NONE
	...
	//		They will come
	//
	explicit inline Object( UnsignedInteger64bits size, UnsignedInteger32bits value, UnsignedInteger64bits key = 0UL );
	...
	inline UnsignedInteger32bits Method_1( UnsignedInteger32bits, UnsignedInteger64bits );

	inline UnsignedInteger32bits Method_2( UnsignedInteger32bits, UnsignedInteger64bits, UnsignedInteger64bits );

	inline void Method_3();

	inline UnsignedInteger32bits Method_4();

    inline void Method_5( UnsignedInteger32bits, UnsignedInteger64bits );

    inline void Method_6( UnsignedInteger32bits*, UnsignedInteger64bits* );

	inline UnsignedInteger32bits Method_1_Constant( UnsignedInteger32bits, UnsignedInteger64bits ) const;

	inline UnsignedInteger32bits Method_2_Constant( UnsignedInteger32bits, UnsignedInteger64bits, UnsignedInteger64bits ) const;

	inline void Method_3_Constant() const;

	inline UnsignedInteger32bits Method_4_Constant() const;

    inline void Method_5_Constant( UnsignedInteger32bits, UnsignedInteger64bits ) const;

    inline void Method_6_Constant( UnsignedInteger32bits*, UnsignedInteger64bits* ) const;

    static inline const UnsignedInteger64bits& GetKey( const Object& instance );
    ...
    //		They will come
    //
    inline UnsignedInteger32bits& operator[]( unsigned int index ) const;
...
private:
	...
	UnsignedInteger32bits* member_memoryAddress;

	// This object will store the size
	UnsignedInteger64bits member_size;

	// This object will act as the key of the object
	UnsignedInteger64bits member_key;

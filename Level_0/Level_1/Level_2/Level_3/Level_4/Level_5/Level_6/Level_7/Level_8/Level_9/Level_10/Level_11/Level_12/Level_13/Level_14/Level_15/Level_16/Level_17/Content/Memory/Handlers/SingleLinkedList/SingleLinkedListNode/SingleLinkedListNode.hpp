...
public:
	...
	using SelfType = SingleLinkedListNode< DataType >;
	...
	//		They will come
	//
	explicit inline SingleLinkedListNode( const DataType& data, SelfType* const nextNode = nullptr );
	...
	//		They will come
	//
	explicit inline SingleLinkedListNode( DataType&& data, SelfType* const nextNode = nullptr );
...
private:
    ...
    DisableCopyAndMove( SingleLinkedListNode );

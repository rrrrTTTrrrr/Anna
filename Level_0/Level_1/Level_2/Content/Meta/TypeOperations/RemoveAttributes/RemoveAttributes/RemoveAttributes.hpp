...
class RemoveAttributes NotForInheritance
{
public:


    // This type definition will be for the same type exactly as the template type
    using Type = typename RemoveVolatileQualifier< typename RemoveConstantQualifier< typename RemoveReference< typename RemovePointer< AnyType >::Type >::Type >::Type >::Type;

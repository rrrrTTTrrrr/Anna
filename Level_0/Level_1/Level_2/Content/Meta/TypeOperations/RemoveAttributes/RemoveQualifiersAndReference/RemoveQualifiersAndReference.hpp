...
class RemoveQualifiersAndReference NotForInheritance
{
public:


    // This type definition will be for the same type exactly as the template type
    using Type = typename RemoveReference< typename RemoveVolatileQualifier< typename RemoveConstantQualifier< AnyType >::Type >::Type >::Type;
...
private :
    ...
    NoInstances( RemoveQualifiersAndReference );


};  //  Class RemoveQualifiersAndReference

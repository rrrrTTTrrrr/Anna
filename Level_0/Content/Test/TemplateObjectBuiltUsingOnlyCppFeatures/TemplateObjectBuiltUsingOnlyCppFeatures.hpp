...
class TemplateObjectBuiltUsingOnlyCppFeatures final
{
public:


	// Create a type definition for this object
	using SelfType = TemplateObjectBuiltUsingOnlyCppFeatures< DataType >;

	// Create a type definition for this object data type
	...
	//		They will come
	//
	explicit inline TemplateObjectBuiltUsingOnlyCppFeatures();
	...
	//		They will come
	//
	explicit inline TemplateObjectBuiltUsingOnlyCppFeatures( unsigned long size, DataType value = DataType() );
	...
	//		They will come
	//
	inline TemplateObjectBuiltUsingOnlyCppFeatures( const SelfType& other );
	...
	//		They will come
	//
	inline TemplateObjectBuiltUsingOnlyCppFeatures( SelfType&& other );
	...
	//		They will come
	//
	inline ~TemplateObjectBuiltUsingOnlyCppFeatures();
    ...
    //		They will come
    //
    inline DataType& operator[]( unsigned long index ) const;
...
private:
	...
	DataType* member_memoryAddress;

	// This object will store the size
	unsigned long member_size;


};  //  Class TemplateObjectBuiltUsingOnlyCppFeatures
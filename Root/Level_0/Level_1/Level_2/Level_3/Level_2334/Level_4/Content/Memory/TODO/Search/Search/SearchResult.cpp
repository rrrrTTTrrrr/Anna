#ifndef  SEARCHRESULT_CPP
#define  SEARCHRESULT_CPP
...
//	********************************************************   PUBLIC METHODS IMPLEMENTATION - INTERFACE   ****************************************************
    	...
    	//	  They will come
    	//
    	SearchResult& SearchResult::operator=( const SearchResult& other ) throw( Exception )
    	{
    	...
    	//      They will come
    	//
    	SearchResult& SearchResult::operator=( SearchResult&& other ) throw( Exception )
    	{
...
// **************************************************************************************   TESTING   ***************************************************************************
    	...
    	DEBUG_TOOL(
    		...
    		//		3. 
    		//
    		void SearchResult::Test() throw( std::bad_alloc, Exception )
    		{
    		}

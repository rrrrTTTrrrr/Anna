...
#include "../../../../Abilities/InitializeStaticArrayUsingMethod/InitializeStaticArrayUsingMethod.hpp"  //  Class InitializeStaticArrayUsingMethod
...
namespace Universe
{
    ...
    namespace CentralProcessingUnit
    {
        ...
        private:
            ...
            const UnsignedInteger64bits member_Basic_EAX_valuesMaximum;
            ...
            const DynamicArray< Array< UnsignedInteger32bits, 4 > > member_centralProcessingUnitBasicInformation;

            // This will decode the information from the CPUID instruction regarding the translation lookaside buffer and store it
            const TranslationLookasideBuffersIdentification member_translationLookasideBuffersIdentification;
	        ...
	        //      They will come
	        //
	        inline UnsignedInteger64bits GetMaximumValueForBasicInformation__Private() const;
	        ...
	        //      They will come
	        //
	        inline DynamicArray< Array< UnsignedInteger32bits, 4 > > GetBasicInformation__Private() const;
...
//  *******************************************************   END PART OF DECLRATIONS, PUBLIC METHODS IMPLMENTATION TIME   *******************************************************
        ...
        member_Basic_EAX_valuesMaximum( GetTheMaximumValueForBasicInformation__Private() ),
...
//  ***********************************************************   TEMPLATE OR INLINE STATIC METHODS IMPLEMENTATION   ************************************************************
        ...
        inline const AsciiCharacter* Identification::VendorIdentificationString() const
        {
            ...
            static const Abilities::InitializeStaticArrayUsingMethod< AsciiCharacter, 13 > vendorIdentificationString( []( AsciiCharacter* vendorIdentificationStringMemoryAddress, UnsignedInteger64bits ) -> void
            {
...
//  ***********************************************************   TEMPLATE OR INLINE PRIVATE METHODS IMPLEMENTATION   ***********************************************************
        ...
        //      They will come
        //
        inline UnsignedInteger64bits Identification::GetMaximumValueForBasicInformation__Private() const
        {
        ...
        //      They will come
        //
        inline DynamicArray< Array< UnsignedInteger32bits, 4 > > Identification::GetBasicInformation__Private() const
        {
            // This object will store the central processing unit basic information
            const DynamicArray< Array< UnsignedInteger32bits, 4 > > centralProcessingUnitBasicInformation( member_Basic_EAX_valuesMaximum );
            ...
            retrun ( MOVE( centralProcessingUnitBasicInformation ) );
        }
        ...
        inline void Identification::InvokeCPUIDandStoreTheResultToTheMemoryAddress__Private( UnsignedInteger32bits set_EAX_toThisValue, UnsignedInteger32bits* memoryAddressToStoreTheInformation, UnsignedInteger32bits set_ECX_toThisValue )
        {
            ...
            ASSERT( ( ( ( set_EAX_toThisValue >= 0x40000000 ) && ( set_EAX_toThisValue <= 0x4FFFFFFF ) ) == false ), "CentralProcessingUnit::Identification::InvokeCPUIDandStoreTheResultToTheMemoryAddress__Private failed - the given value for EAX is out of recognized range" )
            ASSERT( ( memoryAddressToStoreTheInformation != 0 ), "CentralProcessingUnit::Identification::InvokeCPUIDandStoreTheResultToTheMemoryAddress__Private failed - the given pointer is NULL" )

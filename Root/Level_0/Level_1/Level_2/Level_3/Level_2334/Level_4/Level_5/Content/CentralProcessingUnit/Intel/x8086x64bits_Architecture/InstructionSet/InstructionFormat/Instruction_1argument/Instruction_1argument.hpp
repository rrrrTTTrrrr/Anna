#ifndef  INSTRUCTION_1ARGUMENT_HPP
#define  INSTRUCTION_1ARGUMENT_HPP
...
namespace Universe
{
    ...
    namespace CentralProcessingUnit
    {
    	...
    	#define Instruction_1argument_Register_MACRO( InstructionPrefix, InstructionName, Register ) #InstructionPrefix #InstructionName #Register
    	...
    	#define Instruction_1argument_MemoryAddressInRegister_MACRO( InstructionPrefix, InstructionName, MemoryAddressInRegister ) #InstructionPrefix #InstructionName #MemoryAddressInRegister


    	// Use this macro to perform an assembly instruction on a source immediate value and destination register
    	#define Instruction_1argument_ImmedaiteValue_MACRO( InstructionPrefix, InstructionName, ImmediateValue ) #InstructionPrefix #InstructionName ImmediateValue


    	// Use this macro to perform an assembly instruction on a source absolute memory address value and a destination register
    	#define Instruction_1argument_MemoryAddressValue_MACRO( InstructionPrefix, InstructionName, MemoryAddressValue ) #InstructionPrefix #InstructionName [ MemoryAddressValue ]
    	...
    	#define Instruction_1argument_MemoryAddressInRegisterPlusOffset_MACRO( InstructionPrefix, InstructionName, MemoryAddressInRegister, Offset ) #InstructionPrefix #InstructionName [ #MemoryAddressInRegister + Offset ]
    	...
    	#define Instruction_1argument_MemoryAddressInRegisterMultipliedByWidthPlusOffset_MACRO( InstructionPrefix, InstructionName, MemoryAddressInRegister, Width, Offset ) #InstructionPrefix #InstructionName [ #MemoryAddressInRegister * Width + Offset ]


    	// Use this macro to perform an assembly instruction on a source register and destination memory address calculated using the content of the register to multiply with the
    	// width and then add with offset and finally add the content of the base register
    	#define Instruction_1argument_BaseRegisterPlusMemoryAddressInRegisterMultipliedByWidthPlusOffset_MACRO( InstructionPrefix, InstructionName, BaseRegister, MemoryAddressInRegister, Width, Offset ) #InstructionPrefix #InstructionName [ #BaseRegister + #MemoryAddressInRegister * Width + Offset ]
...
#endif  // INSTRUCTION_1ARGUMENT_HPP
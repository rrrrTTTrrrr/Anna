#ifndef  INSTRUCTION_2ARGUMENTS_HPP
#define  INSTRUCTION_2ARGUMENTS_HPP
...
namespace Universe
{
    ...
    namespace CentralProcessingUnit
    {
    	...
    	#define Instruction_2arguments_MemoryAddressInRegister_Register_MACRO( InstructionName, SourceMemoryAddressInRegister, DestinationRegister ) "\"" #InstructionName " " #DestinationRegister "," [ #SourceMemoryAddressInRegister ] "\n\t" "\""


    	// Use this macro to perform an assembly instruction on a surce register and memory address inside the destination register
    	#define Instruction_2arguments_Register_MemoryAddressInRegister_MACRO( InstructionName, SourceRegister, DestinationMemoryAddressInRegister ) "\"" #InstructionName " " [ #DestinationMemoryAddressInRegister ] "," #SourceRegister "\n\t" "\""


    	// Use this macro to perform an assembly instruction on a source immediate value and destination register
    	#define Instruction_2arguments_ImmedaiteValue_Register_MACRO( InstructionName, SourceValue, DestinationRegister ) "\"" #InstructionName " " #DestinationRegister "," SourceValue "\n\t" "\""


    	// Use this macro to perform an assembly instruction on a source absolute memory address value and a destination register
    	#define Instruction_2arguments_MemoryAddressValue_Register_MACRO( InstructionName, SourceMemoryAddressValue, DestinationRegister ) "\"" #InstructionName " " #DestinationRegister "," [ SourceMemoryAddressValue ] "\n\t" "\""


    	// Use this macro to perform an assembly instruction on a source register and an absolute memory address value destination
    	#define Instruction_2arguments_Register_MemoryAddressValue_MACRO( InstructionName, SourceRegister, DestinationMemoryAddressValue ) "\"" #InstructionName " " [ DestinationMemoryAddressValue ] "," #SourceRegister "\n\t" "\""
    	...
    	#define Instruction_2arguments_ImmediateValue_MemoryAddressValue_MACRO( InstructionName, SourceValue, DestinationMemoryAddressValue ) "\"" #InstructionName " " [ DestinationMemoryAddressValue ] "," SourceValue "\n\t" "\""
    	...
    	#define Instruction2arguments_Register_MemoryAddressInRegisterPlusOffset_MACRO( InstructionName, SourceRegister, DestinationMemoryAddressInRegister, Offset ) "\"" #InstructionName " " [ #DestinationMemoryAddressInRegister + Offset ] "," #SourceRegister "\n\t" "\""
    	...
    	#define Instruction2arguments_MemoryAddressInRegisterPlusOffset_Register_MACRO( InstructionName, SourceMemoryAddressInRegister, Offset, DestinationRegister ) "\"" #InstructionName " " #DestinationRegister "," [ #SourceMemoryAddressInRegister + Offset ] "\n\t" "\""
    	...
    	#define Instruction2arguments_Register_MemoryAddressInRegisterMultipliedByWidthPlusOffset_MACRO( InstructionName, SourceRegister, DestinationMemoryAddressInRegister, Width, Offset ) "\"" #InstructionName " " [ #DestinationMemoryAddressInRegister * Width + Offset ] "," #SourceRegister "\n\t" "\""
    	...
    	#define Instruction2arguments_MemoryAddressInRegisterMultipliedByWidthPlusOffset_Register_MACRO( InstructionName, SourceMemoryAddressInRegister, Width, Offset, DestinationRegister ) "\"" #InstructionName " " #DestinationRegister "," [ #SourceMemoryAddressInRegister * Width + Offset ] "\n\t" "\""


    	// Use this macro to perform an assembly instruction on a source register and destination memory address calculated using the content of the register to multiply with the
    	// width and then add with offset and finally add the content of the base register
    	#define Instruction2arguments_Register_BaseRegisterPlusMemoryAddressInRegisterMultipliedByWidthPlusOffset_MACRO( InstructionName, SourceRegister, BaseRegister, DestinationMemoryAddressInRegister, Width, Offset ) "\"" #InstructionName " " [ #BaseRegister + #DestinationMemoryAddressInRegister * Width + Offset ] "," #SourceRegister "\n\t" "\""


    	// Use this macro to perform an assembly instruction on a source memory address calculated using the content of the register to multiply with the width and then add with 
    	// offset and finally add the content of the base register and a destination register
    	#define Instruction2arguments_BaseRegisterPlusMemoryAddressInRegisterMultipliedByWidthPlusOffset_Register_MACRO( InstructionName, BaseRegister, SourceMemoryAddressInRegister, Width, Offset, DestinationRegister ) "\"" #InstructionName " " #DestinationRegister "," [ #BaseRegister + #SourceMemoryAddressInRegister * Width + Offset ] "\n\t" "\""


    	// Use this macro to perform an assembly instruction on a source absolute memory address value and a destination register
    	#define Instruction2arguments_MemoryAddressValue_ImmediateValue_MACRO( InstructionName, SourceMemoryAddressValue, DestinationRegister ) "\"" #InstructionName " " #DestinationRegister "," [ SourceMemoryAddressValue ] "\n\t" "\""
    	...
    	#define Instruction2arguments_ImmediateValue_MemoryAddressInRegisterPlusOffset_MACRO( InstructionName, SourceValue, DestinationMemoryAddressInRegister, Offset ) "\"" #InstructionName " " [ #DestinationMemoryAddressInRegister + Offset ] "," SourceValue "\n\t" "\""
    	...
    	// width and then add with offset
    	#define Instruction2arguments_ImmediateValue_MemoryAddressInRegisterMultipliedByWidthPlusOffset_MACRO( InstructionName, SourceValue, DestinationMemoryAddressInRegister, Width, Offset ) "\"" #InstructionName " " [ #DestinationMemoryAddressInRegister * Width + Offset ] "," SourceValue "\n\t" "\""


    	// Use this macro to perform an assembly instruction on a source value and destination memory address calculated using the content of the register to multiply with the
    	// width and then add with offset and finally add the content of the base register
    	#define Instruction2arguments_ImmediateValue_BaseRegisterPlusMemoryAddressInRegisterMultipliedByWidthPlusOffset_MACRO( InstructionName, SourceValue, BaseRegister, DestinationMemoryAddressInRegister, Width, Offset ) "\"" #InstructionName " " [ #BaseRegister + #DestinationMemoryAddressInRegister * Width + Offset ] "," SourceValue "\n\t" "\""
...
#endif  // INSTRUCTION_2ARGUMENTS_HPP
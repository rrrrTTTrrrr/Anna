#ifndef HEAPSTACK_HPP
#define HEAPSTACK_HPP
...
namespace Universe
{
    ...
    namespace Memory
    {
		...
		class HeapStack : public Stack_Interface< DataType >
		{
		public:
			...
			//		User information needed :
			//
			//			capacity - the maximum number of entries the stack can use
			//
			//		Information returned to the user :
			//
			//			NONE
			...
			//		2. 
			//
			explicit inline HeapStack( UnsignedInteger64bits capacity );
			...
			//		User information needed :
			//
			//			1. capacity - the maximum number of entries the stack can use
			//			2. data - a reference to the first data to push to the stack
			//
			//		Information returned to the user :
			//
			//			NONE
			...
			//		2. 
			//
			explicit inline HeapStack( UnsignedInteger64bits capacity, const DataType& data );
			...
			//		They will come
			//
			explicit inline HeapStack( Tuple< UnsignedInteger64bits > arguments );
			...
			//		They will come
			//
			explicit inline HeapStack( Tuple< UnsignedInteger64bits, const DataType& > arguments );
			...
			//		They will come
			//
			inline HeapStack( const HeapStack< DataType >& other );
			...
			//		5. State
			//
			ObjectInfrastructure_ForInheritance_StateTakenFromMember_MACRO( HeapStack< DataType >, member_heapStack )
			...
			//      They will come
			//
			inline void Swap( HeapStack< DataType >& other );
			...
			//		They will come
			//
			inline Boolean operator==( const HeapStack< DataType >& other ) const;
	        ...
	        static inline HeapStack< DataType > GenerateRandomInstance( NumericRange< UnsignedInteger64bits > rangeForSize = NumericRange< UnsignedInteger64bits >( 1UL, 10000UL ), NumericRange< UnsignedInteger64bits > rangeForCapacity = NumericRange< UnsignedInteger64bits >( 1UL, 10000UL ), ArgumentsTypesNeededToGenerateRandomInstanceOfDataType... argumentsNeededToGenerateRandomInstanceOfDataType );
		...
		private:
 			...
 			HeapArray< DataType > member_heapStack;
...
//	*******************************************************   END PART OF DECLRATIONS, PUBLIC METHODS IMPLMENTATION TIME   *******************************************************
		...
		//
		template< typename DataType >
		inline HeapStack< DataType >::HeapStack() :
		member_heapStack(),
		member_size( 0UL )
		{}
		...
		//
		template< typename DataType >
		inline HeapStack< DataType >::HeapStack( UnsignedInteger64bits capacity ) :
		member_heapStack( capacity ),
		member_size( 0UL )
		{}
		...
		//
		template< typename DataType >
		inline HeapStack< DataType >::HeapStack( UnsignedInteger64bits capacity, const DataType& data ) :
		member_heapStack( capacity ),
		member_size( 1UL )
		{
			// Set the first entry with the data
			member_heapStack[0] = data;
		}
		...
		//
		template< typename DataType >
		inline HeapStack< DataType >::HeapStack( Tuple< UnsignedInteger64bits > arguments ) :
		HeapStack< DataType >( arguments.template Entry< 0 >() )
		{}
		...
		//
		template< typename DataType >
		inline HeapStack< DataType >::HeapStack( Tuple< UnsignedInteger64bits, const DataType& > arguments ) :
		HeapStack< DataType >( arguments.template Entry< 0 >(), arguments.template Entry< 1 >() )
		{}
		...
		//
		template< typename DataType >
		inline HeapStack< DataType >::HeapStack( const HeapStack< DataType >& other ) :
		member_heapStack( other.member_heapStack ),
		...
		//
		template< typename DataType >
		inline void HeapStack< DataType >::Swap( HeapStack< DataType >& other )
		{
		    // Swap between the instances that store the stack
		    member_heapStack.Swap( other.member_heapStack );
		...
		//
		template< typename DataType >
		inline void HeapStack< DataType >::Initiate( UnsignedInteger64bits capacity )
		{
		    ...
		    HeapStack< DataType > temporary( capacity );
		...
		//
		template< typename DataType >
		inline void HeapStack< DataType >::Initiate( UnsignedInteger64bits capacity, const DataType& data )
		{
		    // Use the required constructor to create an instance. It will be used to swap with this instance, leaving this instance in with new data. When sequence control will
		    // leave this scope it will delete the old data
		    HeapStack< DataType > temporary( capacity, data );
		...
		//  Description :
		//
		//      Use this method to get the stack size
		//
		//  Required arguments :
		//
		//		User information needed :
		...
		//
		template< typename DataType >
		UnsignedInteger64bits HeapStack< DataType >::Size() const
		{
		...
		//  Description :
		//
		//      Use this method to get the stack capacity, this is the maximum number of entries that the stack can contain
		//
		//  Required arguments :
		//
		//		User information needed :
		...
		//
		template< typename DataType >
		UnsignedInteger64bits HeapStack< DataType >::Capacity() const
		{
			// Return the capacity of the stack
			return ( member_heapStack.Size() );
		}
		...
		//
		template< typename DataType >
		void HeapStack< DataType >::PushIn( const DataType& data )
		{
			// Each method that interacts with the user directly needs to ensure that the given data is valid
			Assert_MACRO( ( member_size < member_heapStack.Size() ), "The stack can not contain any more entries" )

			// Push the data to the top of the stack
			member_heapStack[ member_size ] = data;
		...
		//
		template< typename DataType >
		DataType HeapStack< DataType >::PopOut()
		{
            // Each method that interacts with the user directly needs to ensure that the given data is valid
			...
			return ( MOVE( member_heapStack[ member_size ] ) );
		}
		...
		//
		template< typename DataType >
		DataType& HeapStack< DataType >::PeakTop()
		{
            // Each method that interacts with the user directly needs to ensure that the given data is valid
            AssertThisInstanceSizeIsLargerThenZero_MACRO

			// Return a reference to the data at the top of the stack
			return ( member_heapStack[ member_size - 1UL ] );
		}
		...
		//
		template< typename DataType >
		const DataType& HeapStack< DataType >::PeakTop() const
		{
            // Each method that interacts with the user directly needs to ensure that the given data is valid
            AssertThisInstanceSizeIsLargerThenZero_MACRO
...
//  **************************************************************  TEMPLATE OR INLINE OPERATORS IMPLEMENTATION   ***************************************************************
		...
		//
		template< typename DataType >
		inline Boolean HeapStack< DataType >::operator==( const HeapStack< DataType >& other ) const
		{
			// Compare the stacks of both instances, and return the result
			return ( member_heapStack == other.member_heapStack );
		}
...
//  ***********************************************************   TEMPLATE OR INLINE STATIC METHODS IMPLEMENTATION   ************************************************************
		...
		template< typename DataType >
        template< typename... ArgumentsTypesNeededToGenerateRandomInstanceOfDataType >
        inline HeapStack< DataType > HeapStack< DataType >::GenerateRandomInstance( NumericRange< UnsignedInteger64bits > rangeForSize, NumericRange< UnsignedInteger64bits > rangeForCapacity, ArgumentsTypesNeededToGenerateRandomInstanceOfDataType... argumentsNeededToGenerateRandomInstanceOfDataType )
        {
			// Each method that interacts with the user directly needs to ensure that the given data is valid
            ...
            // Create an instance
            HeapStack< DataType > randomInstance;

            // Create a random instance of the dynamic sequential platform implementation type and store it
            randomInstance.member_heapStack = MOVE( HeapArray< DataType >::GenerateRandomInstance( rangeForCapacity, argumentsNeededToGenerateRandomInstanceOfDataType... ) );
            ...
            while ( randomInstance.member_size > randomInstance.member_heapStack.Size() )
            {
            	// Pick another size
            	randomInstance.member_size = Random::Generator::Get< UnsignedInteger64bits >( rangeForSize );
            }
...
// *********************************************************************************   TESTING   ********************************************************************************
		...
		// DEBUG_TOOL(
			...
			void HeapStack< DataType >::Test()
			{
				...
				Testing::SanityCheck::Full< HeapStack< DataType > COMMA UnsignedInteger64bits COMMA const DataType& >();
				
				// Create a test instance
				HeapStack< UnsignedInteger64bits > testStack_1( 1234UL );
				...
				// Create a test instance
				HeapStack< UnsignedInteger64bits > testStack_2 = MOVE( HeapStack< UnsignedInteger64bits >::GenerateRandomInstance() );

#ifndef ROOTVARIABLE_HPP
#define ROOTVARIABLE_HPP
...
namespace Universe
{
    ...
    namespace Mathematics
    {
		...
		//
		//			Value of variable = coefficient * ( base ^ exponent )
		//
        ...
        class RootVariable : public Variable_Interface< NumericType >
        {
        public:


			// Create a type definition for this object
			using SelfType = RootVariable< NumericType >;
			...
			//		They will come
			//
			explicit inline RootVariable( NumericType coefficient, NumericType power );
			...
			//		They will come
			//
			explicit inline RootVariable( const Tuple< NumericType, NumericType >& arguments );
			...
			//			2. rangeForCoefficient - this will be used to limit the possible values of the coefficient in the random instance
			//			3. rangeForPower - this will be used to limit the possible values of the power in the random instance
			//
			//		Information returned to the user :
			//
			//			NONE
			...
			//		They will come
			//
			explicit inline RootVariable( RandomInstance, NumericRange< NumericType > rangeForCoefficient = NumericRange< NumericType >(), NumericRange< NumericType > rangeForPower = NumericRange< NumericType >() );
			...
			//		They will come
			//
			inline RootVariable( const SelfType& other );
			...
			//		5. State
			//
			ObjectInfrastructure_ForInheritance_WithStateAlwaysReady_MACRO( RootVariable< NumericType > )
			...
			//		They will come
			//
			inline void Initiate( const Tuple< NumericType >& arguments );
			...
			//		They will come
			//
	        inline void Initiate( RandomInstance, NumericRange< NumericType > rangeForCoefficient = NumericRange< NumericType >(), NumericRange< NumericType > rangeForPower = NumericRange< NumericType >() );
...
//	*******************************************************   END PART OF DECLRATIONS, PUBLIC METHODS IMPLMENTATION TIME   *******************************************************
		...
		//
		template< typename NumericType >
        inline RootVariable< NumericType >::RootVariable() :
		...
		//
		template< typename NumericType >
        inline RootVariable< NumericType >::RootVariable( NumericType coefficient, NumericType power ) :
		Variable_Interface< NumericType >(),
		...
		//
		template< typename NumericType >
		inline RootVariable< NumericType >::RootVariable( const Tuple< NumericType, NumericType >& arguments ) :
		RootVariable( arguments.template Entry< 0 >(), arguments.template Entry< 1 >() )
		{}
		...
		//
		template< typename NumericType >
		inline RootVariable< NumericType >::RootVariable( RandomInstance, NumericRange< NumericType > rangeForCoefficient, NumericRange< NumericType > rangeForPower ) :
		SelfType( Random::Generator::Get< NumericType >( rangeForCoefficient ), Random::Generator::Get< NumericType >( rangeForPower ) )
		{}
		...
		//
		template< typename NumericType >
        inline RootVariable< NumericType >::RootVariable( const SelfType& other ) :
		Variable_Interface< NumericType >(),
		member_coefficient( other.member_coefficient ),
		member_degree( other.member_degree )
		{}
		...
		//
		template< typename NumericType >
		inline void RootVariable< NumericType >::Swap( SelfType& other )
		{
			...
			Memory::Operations::Swap< NumericType >( member_degree, other.member_degree );
		}
		...
		//
		template< typename NumericType >
		inline void RootVariable< NumericType >::Initiate( NumericType coefficient, NumericType power )
		{
		    ...
		    SelfType temporary( coefficient, power );
		...
		//
		template< typename NumericType >
		inline void RootVariable< NumericType >::Initiate( const Tuple< NumericType >& arguments )
		{
		...
		//
		template< typename NumericType >
        inline void RootVariable< NumericType >::Initiate( RandomInstance, NumericRange< NumericType > rangeForCoefficient, NumericRange< NumericType > rangeForPower )
		{
		    // Use the required constructor to create an instance. It will be swaped with this instance, leaving this instance with the new data. When sequence control will
		    // leave this scope it delete the old data if exist
		    SelfType randomGeneratedInstance( GenerateRandomInstance, rangeForCoefficient, rangeForPower );
		...
		//
		template< typename NumericType >
		NumericType RootVariable< NumericType >::Value( NumericType value )
		{
			// Raise the value by the power, multiply by the coefficient, and return the result
			return ( member_coefficient * BaseRaisedByThePower::Calculate< NumericType >( value, member_degree ) );
		}
...
//  **************************************************************  TEMPLATE OR INLINE OPERATORS IMPLEMENTATION   ***************************************************************
		...
		//
		template< typename NumericType >
        inline Boolean RootVariable< NumericType >::operator==( const SelfType& other ) const
		{
			// Compare the coefficients and the powers, and return the result
			return ( ( member_coefficient == other.member_coefficient ) && ( member_degree == other.member_degree ) );
		}
...
// *********************************************************************************   TESTING   ********************************************************************************
		...
		DEBUG_TOOL(
			...
			//
			template< typename NumericType >
			void RootVariable< NumericType >::Test()
			{
				...
				Testing::SanityCheck::Full< SelfType COMMA NumericType COMMA NumericType >();

				// Create a test instance
				RootVariable< UnsignedInteger32bits > testExponentialVariable_1( 45, 3 );

				// Check the results
				Assert_Test_MACRO( testExponentialVariable_1.Value( 2 ) == 360 );
				Assert_Test_MACRO( testExponentialVariable_1.Value( 1 ) == 45 );
				Assert_Test_MACRO( testExponentialVariable_1.Value( 0 ) == 0 );
				Assert_Test_MACRO( testExponentialVariable_1.Value( 10 ) == 45000 );

				// Create a test instance of signed nature
				RootVariable< SignedInteger32bits > testExponentialVariable_2( 2, 3 );

				// Check the results
				Assert_Test_MACRO( testExponentialVariable_2.Value( 2 ) == 16 );
				Assert_Test_MACRO( testExponentialVariable_2.Value( 1 ) == 2 );
				Assert_Test_MACRO( testExponentialVariable_2.Value( 0 ) == 0 );
				Assert_Test_MACRO( testExponentialVariable_2.Value( 10 ) == 2000 );
				Assert_Test_MACRO( testExponentialVariable_2.Value( -1 ) == -2 );
				Assert_Test_MACRO( testExponentialVariable_2.Value( -8 ) == -1024 );
			}

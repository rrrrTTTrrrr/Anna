#ifndef  CENTRALPROCESSINGUNITCLOCKCYCLECOUNTER_HPP
#define  CENTRALPROCESSINGUNITCLOCKCYCLECOUNTER_HPP


#include "../Definitions/VariableTypesDefinitions.hpp"  //  Typedef
#include "../BasicUtilities/C++/cpp_BasicUtilities.hpp"  //  Macro DEBUG_ONLY, Macro COMMA, Class NoInstances
...
namespace Universe
{
    ...
    namespace CentralProcessingUnit
    {
    	...
    	//		Too many to count
    	//
    	class CentralProcessingUnitClockCycleCounter
    	{
    	public:
...
#endif  // CENTRALPROCESSINGUNITCLOCKCYCLECOUNTER_HPP
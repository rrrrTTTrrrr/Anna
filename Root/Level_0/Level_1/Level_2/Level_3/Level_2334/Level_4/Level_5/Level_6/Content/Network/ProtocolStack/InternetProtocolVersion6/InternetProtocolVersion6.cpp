#ifndef  INTERNETPROTOCOLVERSION6_CPP
#define  INTERNETPROTOCOLVERSION6_CPP



#include "INTERNETPROTOCOLVERSION6.hpp"
...
//	********************************************************   PUBLIC METHODS IMPLEMENTATION - INTERFACE   ****************************************************
    	...
    	//	  They will come
    	//
    	InternetProtocolVersion6& InternetProtocolVersion6::operator=( const InternetProtocolVersion6& other ) throw( Exception )
    	{
    	...
    	//      They will come
    	//
    	InternetProtocolVersion6& InternetProtocolVersion6::operator=( InternetProtocolVersion6&& other ) throw( Exception )
    	{
...
// **************************************************************************************   TESTING   ***************************************************************************
    	...
    	DEBUG_TOOL(
    		...
    		//		3. 
    		//
    		void InternetProtocolVersion6::Test() throw( std::bad_alloc, Exception )
    		{
    		}
...
#endif  //  INTERNETPROTOCOLVERSION6_CPP

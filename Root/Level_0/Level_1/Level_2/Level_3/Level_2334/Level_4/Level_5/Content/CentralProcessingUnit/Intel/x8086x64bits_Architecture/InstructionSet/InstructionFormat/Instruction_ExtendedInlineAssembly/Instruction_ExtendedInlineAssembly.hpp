#ifndef  INSTRUCTION_EXTENDEDINLINEASSEMBLY_HPP
#define  INSTRUCTION_EXTENDEDINLINEASSEMBLY_HPP
...
namespace Universe
{
    ...
    namespace CentralProcessingUnit
    {
    	...
    	#define Instruction_ExtendedInlineAssembly_2arguments_Register_ImmediateValue_MACRO1( InstructionName, SourceImmediateValue, DestinationRegister ) "\"" #InstructionName " " #DestinationRegister ", " "%[" #SourceImmediateValue "]\n\t" "\""


        #define Instruction_ExtendedInlineAssembly_2arguments_Register_ImmediateValue_MACRO( InstructionName, SourceImmediateValue, DestinationRegister ) Concatenate2piecesOfText_MACRO( InstructionName, DestinationRegister )
...
#endif  // INSTRUCTION_EXTENDEDINLINEASSEMBLY_HPP
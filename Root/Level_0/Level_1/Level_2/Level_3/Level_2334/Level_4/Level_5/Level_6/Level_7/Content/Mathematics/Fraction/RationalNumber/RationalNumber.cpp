...
//  ************************************************************************   OPERATORS IMPLEMENTATION   ***********************************************************************
        ...
        {            
        	...
        	if ( ( member_sign == 1 ) && ( rightSideOperand.member_sign == 1 ) )
        	{
        		...
        		ReturnValueIfExpressionIsTrue_MACRO( ( thisModifiedNumerator < otherModifiedNumerator ), false )
        	}
        	else
        	{
...
//	********************************************************************   PRIVATE METHODS IMPLEMENTATION   *********************************************************************
		...
		void RationalNumber::SimplifiedForm__Private()
		{
			...
			ReturnIfExpressionIsTrue_MACRO( ( member_numerator == 0UL ) || ( member_numerator == 1UL ) || ( member_denominator == 1UL ) )
			...
			ReturnIfExpressionIsTrue_MACRO( Numbers::PrimalityTest( member_numerator ) == true )
			ReturnIfExpressionIsTrue_MACRO( Numbers::PrimalityTest( member_denominator ) == true )
...
// *********************************************************************************   TESTING   ********************************************************************************
		...
		DEBUG_TOOL(
			...
			void RationalNumber::Test()
			{
				...
				Assert_Test_MACRO( ( ( testRationalNumber_1.member_numerator == 2UL ) && ( testRationalNumber_1.member_denominator == 87UL ) ) )

				// Create a test instance
				RationalNumber testRationalNumber_2( 4, 87 );

				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_2.member_numerator == 4UL ) && ( testRationalNumber_2.member_denominator == 87UL ) ) )

				// Create a test instance
				RationalNumber testRationalNumber_3( 4, 88 );

				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_3.member_numerator == 1UL ) && ( testRationalNumber_3.member_denominator == 22UL ) ) )

				// Create a test instance
				RationalNumber testRationalNumber_4( 3, 7 );

				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_4.member_numerator == 3UL ) && ( testRationalNumber_4.member_denominator == 7UL ) ) )

				// Create a test instance
				RationalNumber testRationalNumber_5( 0, 7 );

				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_5.member_numerator == 0UL ) && ( testRationalNumber_5.member_denominator == 7UL ) ) )

				// Create a test instance
				RationalNumber testRationalNumber_6( 80, 450 );

				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_6.member_numerator == 8UL ) && ( testRationalNumber_6.member_denominator == 45UL ) ) )
				...
				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_7.member_numerator == 25UL ) && ( testRationalNumber_7.member_denominator == 3UL ) ) )

				// Try the addition operator
				testRationalNumber_7 += 3UL;

				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_7.member_numerator == 34UL ) && ( testRationalNumber_7.member_denominator == 3UL ) ) )
				...
				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_7.member_numerator == 1UL ) && ( testRationalNumber_7.member_denominator == 3UL ) ) )
				...
				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_7.member_numerator == 2UL ) && ( testRationalNumber_7.member_denominator == 3UL ) ) )

				// Try the addition operator
				testRationalNumber_7 += testRationalNumber_8;

				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_7.member_numerator == 1UL ) && ( testRationalNumber_7.member_denominator == 1UL ) ) )

				// Try the addition operator
				testRationalNumber_8 += testRationalNumber_7;

				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_8.member_numerator == 4UL ) && ( testRationalNumber_8.member_denominator == 3UL ) ) )

				// Try the addition operator
				testRationalNumber_8 += testRationalNumber_7;

				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_8.member_numerator == 7UL ) && ( testRationalNumber_8.member_denominator == 3UL ) ) )

				// Try the addition operator
				testRationalNumber_8 += testRationalNumber_7;

				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_8.member_numerator == 10UL ) && ( testRationalNumber_8.member_denominator == 3UL ) ) )
				...
				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_8.member_numerator == 89UL ) && ( testRationalNumber_8.member_denominator == 24UL ) ) )

				// Try the addition operator
				testRationalNumber_8 += testRationalNumber_9;

				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_8.member_numerator == 49UL ) && ( testRationalNumber_8.member_denominator == 12UL ) ) )
				...
				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( ( testRationalNumber_8.member_numerator == 623UL ) && ( testRationalNumber_8.member_denominator == 132UL ) ) )
				...
				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( testRationalNumber_11 < testRationalNumber_12 ) == true )
				Assert_Test_MACRO( ( testRationalNumber_11 > testRationalNumber_12 ) == false )
				...
				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( testRationalNumber_13 < testRationalNumber_14 ) == true )
				Assert_Test_MACRO( ( testRationalNumber_13 > testRationalNumber_14 ) == false )
				...
				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( testRationalNumber_15 < testRationalNumber_16 ) == true )
				Assert_Test_MACRO( ( testRationalNumber_15 > testRationalNumber_16 ) == false )
				...
				// Assert that the operation performed correctly
				Assert_Test_MACRO( ( testRationalNumber_17 < testRationalNumber_18 ) == false )
				Assert_Test_MACRO( ( testRationalNumber_17 > testRationalNumber_18 ) == true )

                // Create a test instance                
				RationalNumber testRationalNumber_19 = ( 56UL + testRationalNumber_18 );

                // Assert that the operation performed correctly
                Assert_Test_MACRO( ( ( testRationalNumber_19.member_numerator == 1486UL ) && ( testRationalNumber_19.member_denominator == 11UL ) ) )
			}

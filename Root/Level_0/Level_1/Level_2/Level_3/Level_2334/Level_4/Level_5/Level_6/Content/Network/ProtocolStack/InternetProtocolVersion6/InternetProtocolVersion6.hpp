#ifndef  INTERNETPROTOCOLVERSION6_HPP
#define  INTERNETPROTOCOLVERSION6_HPP
...
namespace Universe
{
    ...
    namespace 
    {
    	...
    	//
    	//
    	class InternetProtocolVersion6
        {
        public:
    		...
    		//		They will come
    		//
    		explicit inline InternetProtocolVersion6() throw();
    		...
    		//		They will come
    		//
    		explicit InternetProtocolVersion6() throw( Exception );
    		...
    		//		They will come
    		//
    		InternetProtocolVersion6( const InternetProtocolVersion6& other ) throw( Exception );
    		...
    		//		They will come
    		//
    		InternetProtocolVersion6& operator=( const InternetProtocolVersion6& other ) throw( Exception );
    		...
    		//		They will come
    		//
    		InternetProtocolVersion6( InternetProtocolVersion6&& other ) throw( Exception );
    		...
    		//		They will come
    		//
    		InternetProtocolVersion6& operator=( InternetProtocolVersion6&& other ) throw( Exception );
    		...
    		//		They will come
    		//
    		inline ~InternetProtocolVersion6() throw();
    		...
    		//      3. 
    		//
    		bool operator==( const InternetProtocolVersion6& other ) const throw( Exception );
...
//	****************************************************************   END PART OF DECLRATIONS, IMPLMENTATION TIME   ************************************************************
    	...
    	//		They will come
    	//
    	inline InternetProtocolVersion6::InternetProtocolVersion6() throw() :
    	...
    	//		They will come
    	//
    	InternetProtocolVersion6::InternetProtocolVersion6( UnsignedInteger8bits trafficClass, 
    		                                                UnsignedInteger32bits flowLabel, 
    		                                                UnsignedInteger16bits payloadLength,
    		                                                UnsignedInteger8bits nextHeader,
    		                                                UnsignedInteger8bits hopLimit,
    		                                                Unsi) throw( Exception ) :
    	...
    	//		They will come
    	//
    	InternetProtocolVersion6::InternetProtocolVersion6( const InternetProtocolVersion6& other ) throw( Exception ) :
    	...
    	//		They will come
    	//
    	InternetProtocolVersion6::InternetProtocolVersion6( InternetProtocolVersion6&& other ) throw( Exception ) :
    	{
    	...
    	//	    They will come
    	//
    	void InternetProtocolVersion6::SetToDefaultState() throw()
    	...
    	//		They will come
    	//
    	bool InternetProtocolVersion6::DefaultState() throw() const
    	{
    	...
    	//      2.
    	//
    	void InternetProtocolVersion6::DeleteResourcesAndSetToDefaultState() throw()
    	{
...
//  ***************************************************************  TEMPLATE OR INLINE OPERATORS IMPLEMENTATION   ************************************************
    	...
    	//      3. 
    	//
    	bool InternetProtocolVersion6::operator==( const InternetProtocolVersion6& other ) const throw( Exception )
...
#endif  // INTERNETPROTOCOLVERSION6_HPP
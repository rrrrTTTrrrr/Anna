#ifndef SYSTEMMEMORY_FILESYSTEM_CPP
#define SYSTEMMEMORY_FILESYSTEM_CPP


#include "SystemMemory_FileSystem.hpp"
...
// *********************************************************************************   TESTING   ********************************************************************************
		...
		DEBUG_TOOL(
			...
			//		3. 
			//
			void SystemMemory_FileSystem::Test()
			{
				...
				Testing::SanityCheck::Full< SystemMemory_FileSystem,  >();
			}
...
#endif  //  SYSTEMMEMORY_FILESYSTEM_CPP

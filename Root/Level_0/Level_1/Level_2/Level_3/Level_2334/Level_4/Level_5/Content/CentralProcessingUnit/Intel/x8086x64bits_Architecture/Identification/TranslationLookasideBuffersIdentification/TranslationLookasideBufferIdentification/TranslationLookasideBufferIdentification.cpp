#ifndef TRANSLATIONLOOKASIDEBUFFERIDENTIFICATION_CPP
#define TRANSLATIONLOOKASIDEBUFFERIDENTIFICATION_CPP


#include "TranslationLookasideBufferIdentification.hpp"
...
//	********************************************************************   PRIVATE METHODS IMPLEMENTATION   *********************************************************************
        ...
        //
        //          byteDescriptor - this will be used to determine if it contains translation lookaside buufer information, and also the specific type
        //
        ...
        //      They will come
        //
        void TranslationLookasideBufferIdentification::InitializeInstanceWithTranslationLookasideBufferAttributesRepresentedByByteDescriptor__Private( UnsignedInteger8bits byteDescriptor )
        {

            // Switch case to choose the byte describing value
            switch ( byteDescriptor )
            {

                // For byte descriptor with value 0x01
                case 0x01 :
                {
                	// Description :
                	//
                    ...
                    member_associativityKnown = true;

                    // This is set associativity, the value was already set to false

                    // This value represents 4 KiloByte pages
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].First() = KiloByte( 4UL );

                    // This value represents a 4 way set associative
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Second() = 4UL;

                    // This value represents 32 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Third() = 32UL;

                    // There is nothing else to do
                    break;
                }
                // For byte descriptor with value 0x02
                case 0x02 :
                {
                	// Description :
                	//
                    ...
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].First() = MegaByte( 4UL );

                    // This value represents 2 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Third() = 2UL;

                    // There is nothing else to do
                    break;
                }
                // For byte descriptor with value 0x03
                case 0x03 :
                {
                	// Description :
                	//
                    ...
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Third() = 64UL;

                    // There is nothing else to do
                    break;
                }
                // For byte descriptor with value 0x04
                case 0x04 :
                {
                	// Description :
                	//
                    ...
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Third() = 8UL;

                    // There is nothing else to do
                    break;
                }
                // For byte descriptor with value 0x05
                case 0x05 :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0x0B
                case 0x0B :
                {
                	// Description :
                	//
                    ...
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Third() = 4UL;

                    // There is nothing else to do
                    break;
                }
                // For byte descriptor with value 0x4F
                case 0x4F :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0x50
                case 0x50 :
                {
                	// Description :
                	//
                    ...
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].First() = MegaByte( 2UL );

                    // This value represents 64 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].Third() = 64UL;

                    // This value represents 4 MegaByte pages
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[2].First() = MegaByte( 4UL );

                    // This value represents 64 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[2].Third() = 64UL;
                ...
                // For byte descriptor with value 0x51
                case 0x51 :
                {
                	// Description :
                	//
                    ...
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Third() = 128UL;

                    // This value represents 2 MegaByte pages
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].First() = MegaByte( 2UL );

                    // This value represents 128 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].Third() = 128UL;

                    // This value represents 4 MegaByte pages
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[2].First() = MegaByte( 4UL );

                    // This value represents 128 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[2].Third() = 128UL;
                ...
                // For byte descriptor with value 0x52
                case 0x52 :
                {
                	// Description :
                	//
                    ...
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Third() = 256UL;

                    // This value represents 2 MegaByte pages
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].First() = MegaByte( 2UL );

                    // This value represents 256 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].Third() = 256UL;

                    // This value represents 4 MegaByte pages
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[2].First() = MegaByte( 4UL );

                    // This value represents 256 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[2].Third() = 256UL;
                ...
                // For byte descriptor with value 0x55
                case 0x55 :
                {
                	// Description :
                	//
                    ...
                    // This value represents 2 MegaByte pages
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].First() = MegaByte( 2UL );

                    // This value represents 7 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Third() = 7UL;

                    // This value represents 4 MegaByte pages
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].First() = MegaByte( 4UL );

                    // This value represents 7 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].Third() = 7UL;
                ...
                // For byte descriptor with value 0x56
                case 0x56 :
                {
                	// Description :
                	//
                    ...
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Third() = 16UL;

                    // There is nothing else to do
                    break;
                }
                // For byte descriptor with value 0x57
                case 0x57 :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0x59
                case 0x59 :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0x5A
                case 0x5A :
                {
                	// Description :
                	//
                    ...
                    // This value represents a 4 way set associative
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].Second() = 4UL;

                    // This value represents 32 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].Third() = 32UL;
                ...
                // For byte descriptor with value 0x5B
                case 0x5B :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0x5C
                case 0x5C :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0x5D
                case 0x5D :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0x61
                case 0x61 :
                {
                	// Description :
                	//
                    ...
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Third() = 48UL;

                    // There is nothing else to do
                    break;
                }
                // For byte descriptor with value 0x64
                case 0x64 :
                {
                	// Description :
                	//
                    ...
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Third() = 512UL;

                    // There is nothing else to do
                    break;
                }
                // For byte descriptor with value 0x76
                case 0x76 :
                {
                	// Description :
                	//
                    ...
                    // This value represents 8 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].Third() = 8UL;

                    // There is nothing else to do
                    break;
                }
                // For byte descriptor with value 0xA0
                case 0xA0 :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0xB0
                case 0xB0 :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0xB1
                case 0xB1 :
                {
                	// Description :
                	//
                    ...
                    // This value represents 4 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].Third() = 4UL;
                ...
                // For byte descriptor with value 0xB2
                case 0xB2 :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0xB3
                case 0xB3 :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0xB4
                case 0xB4 :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0xB5
                case 0xB5 :
                {
                	// Description :
                	//
                    ...
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Second() = 8UL;
                ...
                // For byte descriptor with value 0xB6
                case 0xB6 :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0xBA
                case 0xBA :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0xC0
                case 0xC0 :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0xC1
                case 0xC1 :
                {
                	// Description :
                	//
                    ...
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Third() = 1024UL;
                    ...
                    // This value represents 1024 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].Third() = 1024UL;
                ...
                // For byte descriptor with value 0xC2
                case 0xC2 :
                {
                	// Description :
                	//
                    ...
                    // This value represents 16 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].Third() = 16UL;
                ...
                // For byte descriptor with value 0xC3
                case 0xC3 :
                {
                	// Description :
                	//
                    ...
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Second() = 6UL;

                    // This value represents 1536 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[0].Third() = 1536UL;
                    ...
                    // This value represents 1536 entries
                    member_supportedPageSizesInBytesAssociatedWithNumberOfEntriesAndTheNumberOfWaySetAssociative[1].Third() = 1536UL;
                ...
                // For byte descriptor with value 0xC4
                case 0xC4 :
                {
                	// Description :
                	//
                ...
                // For byte descriptor with value 0xCA
                case 0xCA :
                {
                	// Description :
                	//
                ...
                // Every other value given does not represents translation lookaside buffer information
                default :
                {
                    // The given byte descriptor is invalid, throw an exception describing the problem
                    ThrowException( "The given byte descriptor does represent translation lookaside buffer" );                     
                }
...
// *********************************************************************************   TESTING   ********************************************************************************
		...
		DEBUG_TOOL(
			...
			//		3. 
			//
			void TranslationLookasideBufferIdentification::Test()
			{
				// Create an instance
				TranslationLookasideBufferIdentification testTranslationLookasideBufferIdentification_1;
			}
...
#endif  //  TRANSLATIONLOOKASIDEBUFFERIDENTIFICATION_CPP

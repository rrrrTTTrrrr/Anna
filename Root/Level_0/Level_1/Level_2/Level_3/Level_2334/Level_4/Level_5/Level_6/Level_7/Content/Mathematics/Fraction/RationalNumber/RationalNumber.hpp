...
namespace Universe
{
	...
	namespace Mathematics
    {
		...
		public:
			...
			//		5. State
			//
			ObjectInfrastructure_WithStateAlwaysReady_MACRO( RationalNumber )
			...
			//		They will come
			//
			static inline RationalNumber GenerateRandomInstance( NumericRange< UnsignedInteger64bits > rangeForNumerator = NumericRange< UnsignedInteger64bits >(), NumericRange< UnsignedInteger64bits > rangeForDenominator = NumericRange< UnsignedInteger64bits >() );
...
//	*******************************************************   END PART OF DECLRATIONS, PUBLIC METHODS IMPLMENTATION TIME   *******************************************************
		...
		member_sign( ( sign == true ) ? 1 : -1 )
		{
			...
			Assert_MACRO( ( denominator != 0 ), "The denominator can not be 0" )
...
//  **************************************************************  TEMPLATE OR INLINE OPERATORS IMPLEMENTATION   ***************************************************************
        ...
        {      
        	...
        	// is larger
        	ReturnValueIfExpressionIsTrue_MACRO( ( member_sign == -1 ), false )
...
//  ***********************************************************   TEMPLATE OR INLINE STATIC METHODS IMPLEMENTATION   ************************************************************
		...
		//		They will come
		//
		inline RationalNumber RationalNumber::GenerateRandomInstance( NumericRange< UnsignedInteger64bits > rangeForNumerator, NumericRange< UnsignedInteger64bits > rangeForDenominator )
		{
			// This object will store the denominator

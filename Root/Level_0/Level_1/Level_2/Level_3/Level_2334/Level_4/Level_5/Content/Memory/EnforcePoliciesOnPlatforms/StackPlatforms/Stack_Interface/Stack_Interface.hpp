...
namespace Universe
{
	...
	namespace Memory
    {
		...
		public:
			...
			//		They will come
			//
			inline Stack_Interface() = default;
			...
			//		They will come
			//
			inline Stack_Interface( const Stack_Interface< DataType >& other ) = default;
			...
			//      They will come
			//
			inline Stack_Interface< DataType >& operator=( const Stack_Interface< DataType >& other ) = default;
			...
			//      They will come
			//
			inline Stack_Interface( Stack_Interface< DataType >&& other ) = default;
			...
			//      They will come
			//
			inline Stack_Interface< DataType >& operator=( Stack_Interface< DataType >&& other ) = default;

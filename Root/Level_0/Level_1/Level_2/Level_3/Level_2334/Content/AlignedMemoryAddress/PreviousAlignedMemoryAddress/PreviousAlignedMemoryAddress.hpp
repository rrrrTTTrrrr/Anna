#ifndef PREVIOUSALIGNEDMEMORYADDRESS_HPP
#define PREVIOUSALIGNEDMEMORYADDRESS_HPP
...
namespace Universe
{
	...
	class PreviousAlignedMemoryAddress
	{
	public:
	...
	private:
		...
		NoInstances_MACRO( PreviousAlignedMemoryAddress )
		...
		CompileTimeAssert( ( IsPowerOfTwo< UnsignedInteger64bits >::Check( Alignment ) == true ), "PreviousAlignedMemoryAddress failed - the given alignment should be a power of 2" );
...
#include "PreviousAlignedMemoryAddress.inl"
...
#endif  // PREVIOUSALIGNEDMEMORYADDRESS_HPP
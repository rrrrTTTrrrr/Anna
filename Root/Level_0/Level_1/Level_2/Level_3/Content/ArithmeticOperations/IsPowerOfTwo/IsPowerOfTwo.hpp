#ifndef ISPOWEROFTWO_HPP
#define ISPOWEROFTWO_HPP
...
namespace Universe
{
	...
	//  Purpose :
	//
	//		Use this object to check if an integer value is a power of 2
	//
    //  Description :
    //
	...
	public:
		...
		//  Description :
		//
		//		Use this method to check if the given integer value is a power of 2
		//
		//  Required arguments :
		//
		...
		//		They will come
		//
		static inline Boolean Check( UnsignedIntegerType value );
	...
	private:
		...
		NoInstances_MACRO( IsPowerOfTwo )

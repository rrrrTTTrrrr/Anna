...
namespace Universe
{
	...
	//
	//			1. ReturnValueType - the return value type of the required function
	//			2. FunctionArgumentTypes - the arguments types of the required function
	//
	//  Expectations :
	//
	//		NONE
	...
	class FunctionPointer : public BaseInvokableObject< ReturnValueType, FunctionArgumentTypes... >, public Functor_Interface< ReturnValueType, FunctionArgumentTypes... >
	{
	public:


        // Create a type definition for this object
        using SelfType = FunctionPointer< ReturnValueType, FunctionArgumentTypes... >;

		// Create a type definition for the function using the specific given template arguments
		using FunctionPointerType = ReturnValueType (*)( FunctionArgumentTypes... );
		...
		//		User information needed :
		//
		//			functionMemoryAddress - the memory address of the function to call
		//
		//		Information returned to the user :
		//
		//			NONE
		...
		//		They will come
		//
		inline FunctionPointer( FunctionPointerType functionMemoryAddress );
		...
		//		They will come
		//
		inline FunctionPointer( const FunctionPointer< ReturnValueType, FunctionArgumentTypes... >& other );
		...
		//		5. State
		//
		ObjectInfrastructure_ForInheritance_MACRO( ConsiderAsOneArgument( FunctionPointer< ReturnValueType, FunctionArgumentTypes... > ) )
		...
		//		2.
		//
		virtual ReturnValueType operator()( FunctionArgumentTypes... arguments ) override;
		...
		//		2.
		//
		inline ReturnValueType operator()( FunctionArgumentTypes... arguments ) const;
		...
		//		2.
	    //
	    virtual ReturnValueType operator()( const Tuple< FunctionArgumentTypes... >& arguments ) override;
		...
		//		2.
	    //
	    inline ReturnValueType operator()( const Tuple< FunctionArgumentTypes... >& arguments ) const;
		...
		//		They will come
		//
		inline Boolean operator==( const FunctionPointer< ReturnValueType, FunctionArgumentTypes... >& other ) const;
	...
	private:
	    ...
	    inline ReturnValueType InvokeUsingTuple__Private( const Tuple< FunctionArgumentTypes... >& arguments, IncrementingIntegerSequenceHolder< ArgumentIndices... > ) const;
...
// ************************************************************************************************************************************************************************** //
	...
	//		3. Template arguments :
	//
	//			ReturnValueType - the return value type of the required function
	//
	//  Expectations :
	//
	//		NONE
	...
	class FunctionPointer< ReturnValueType > : public BaseInvokableObject< ReturnValueType >, public Functor_Interface< ReturnValueType >
	{
	public:


        // Create a type definition for this object
        using SelfType = FunctionPointer< ReturnValueType >;

		// Create a type definition for the function using the specific given template arguments
		using FunctionPointerType = ReturnValueType (*)();
		...
		//		They will come
		//
		inline FunctionPointer( const FunctionPointer< ReturnValueType >& other );
		...
		//		5. Reset
		//
		ObjectInfrastructure_ForInheritance_MACRO( FunctionPointer< ReturnValueType > )
		...
		//		They will come
		//
		inline Boolean operator==( const FunctionPointer< ReturnValueType >& other ) const;
		...
		DEBUG_TOOL(
			...
			//		It says there are no problems, which is even scarier, did I just wrote a working code??
			//
			static void Test() __attribute__ (( __unused__ )) { FunctionPointer< UnsignedInteger64bits COMMA UnsignedInteger64bits >::Test(); }

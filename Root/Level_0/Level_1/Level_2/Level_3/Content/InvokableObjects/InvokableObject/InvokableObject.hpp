...
#ifdef TEST_MODE
#include "../../../../../../../../Test/TestingTools/Functions/TestFunctions.hpp"  //  Class TestFunctions
...
namespace Universe
{
	...
	public:
		...
		//
		template< typename ObjectType >
		inline InvokableObject( const LambdaExpression< ObjectType, ReturnValueType, ArgumentTypes... >& lambdaExpression );
		...
		//
		template< typename ObjectType >
		inline InvokableObject( const FunctorInvoker< ObjectType, ReturnValueType, ArgumentTypes... >& functor );
	...
	private:
		...
		Functor_Interface< ReturnValueType, ArgumentTypes... >* member_invokableObject;
...
//	*******************************************************   END PART OF DECLRATIONS, PUBLIC METHODS IMPLMENTATION TIME   *******************************************************
	...
	member_type( InvokableObjectType::Function )
	{
		...
		member_invokableObject = new FunctionPointer< ReturnValueType, ArgumentTypes... >( functionPointer );
	}
	...
	member_type( InvokableObjectType::Method )
	{
		...
		member_invokableObject = new MethodPointerBoundToSpecificInstance< ObjectType, ReturnValueType, ArgumentTypes... >( boundMethodPointer );
	}
	...
	template< typename ReturnValueType, typename... ArgumentTypes >
	template< typename ObjectType >
	inline InvokableObject< ReturnValueType, ArgumentTypes... >::InvokableObject( const LambdaExpression< ObjectType, ReturnValueType, ArgumentTypes... >& lambdaExpression ) :
	member_state( InstanceState::Ready ),
	member_invokableObject( nullptr ),
	member_type( InvokableObjectType::LambdaExpression )
	{
		...
		member_invokableObject = new LambdaExpression< ObjectType, ReturnValueType, ArgumentTypes... >( lambdaExpression );
	}
	...
	template< typename ReturnValueType, typename... ArgumentTypes >
	template< typename ObjectType >
	inline InvokableObject< ReturnValueType, ArgumentTypes... >::InvokableObject( const FunctorInvoker< ObjectType, ReturnValueType, ArgumentTypes... >& functor ) :
	member_state( InstanceState::Ready ),
	member_invokableObject( nullptr ),
	member_type( InvokableObjectType::Functor )
	{
		...
		member_invokableObject = new FunctorInvoker< ObjectType, ReturnValueType, ArgumentTypes... >( functor );
	}
	...
	inline void InvokableObject< ReturnValueType, ArgumentTypes... >::Swap( InvokableObject< ReturnValueType, ArgumentTypes... >& other )
	{
	    ...
	    Memory::Operations::Swap< Functor_Interface< ReturnValueType, ArgumentTypes... >* >( member_invokableObject, other.member_invokableObject );
...
// ************************************************************************************************************************************************************************** //
	...
	public:
		...
		//
		template< typename ObjectType >
		inline InvokableObject( const LambdaExpression< ObjectType, ReturnValueType >& lambdaExpression );
		...
		//
		template< typename ObjectType >
		inline InvokableObject( const FunctorInvoker< ObjectType, ReturnValueType >& functor );
	...
	private:
		...
		// This pointer will store the memory address allocated on the heap for the derived instance. This is can by an invokable object, this
		// includes functions, methods, lambda expressions and functors 
		Functor_Interface< ReturnValueType >* member_invokableObject;
...
//	*******************************************************   END PART OF DECLRATIONS, PUBLIC METHODS IMPLMENTATION TIME   *******************************************************
	...
	member_type( InvokableObjectType::Function )
	{
		...
		// Allocate memory space on the heap memory segment to store the function pointer
		member_invokableObject = new FunctionPointer< ReturnValueType >( functionPointer );
	}
	...
	member_type( InvokableObjectType::Method )
	{
		...
		// Allocate memory space on the heap memory segment to store the method pointer
		member_invokableObject = new MethodPointerBoundToSpecificInstance< ObjectType, ReturnValueType >( boundMethodPointer );
	}
	...
	template< typename ReturnValueType >
	template< typename ObjectType >
	inline InvokableObject< ReturnValueType >::InvokableObject( const LambdaExpression< ObjectType, ReturnValueType >& lambdaExpression ) :
	member_state( InstanceState::Ready ),
	member_invokableObject( nullptr ),
	member_type( InvokableObjectType::LambdaExpression )
	{
		...
		// Allocate memory space on the heap memory segment to store the lambda expression
		member_invokableObject = new LambdaExpression< ObjectType, ReturnValueType >( lambdaExpression );
	}
	...
	template< typename ReturnValueType >
	template< typename ObjectType >
	inline InvokableObject< ReturnValueType >::InvokableObject( const FunctorInvoker< ObjectType, ReturnValueType >& functor ) :
	member_state( InstanceState::Ready ),
	member_invokableObject( nullptr ),
	member_type( InvokableObjectType::LambdaExpression )
	{
		...
		// Allocate memory space on the heap memory segment to store the functor
		member_invokableObject = new FunctorInvoker< ObjectType, ReturnValueType >( functor );
	}
	...
	inline void InvokableObject< ReturnValueType >::Swap( InvokableObject< ReturnValueType >& other )
	{
	    ...
	    // Swap between the invokable instances
	    Memory::Operations::Swap< Functor_Interface< ReturnValueType >* >( member_invokableObject, other.member_invokableObject );

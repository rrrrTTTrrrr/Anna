#ifndef BASEINVOKABLEOBJECT_HPP
#define BASEINVOKABLEOBJECT_HPP
...
namespace Universe
{
    ...
    public:
		...
		//		They will come
		//
		constexpr Boolean ArgumentsNeeded() const;
		...
		//  Return value :
		//
		//		The number of arguments required to invoke the function
		//
		//  Expectations :
		//
		//		NONE
		...
		//		They will come
		//
		constexpr UnsignedInteger64bits ArgumentsNumber() const;
		...
		//		They will come
		//
		constexpr Boolean ReturnValueExist() const;
...
//	*******************************************************   END PART OF DECLRATIONS, PUBLIC METHODS IMPLMENTATION TIME   *******************************************************
	...
	{
		// There function required argumetns to be called, return true
		return ( true );
	}
	...
	{
		// There is a retrun value, return true

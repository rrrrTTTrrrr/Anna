#ifndef ACCESSDATAUSINGINDICES_INTERFACE_HPP
#define ACCESSDATAUSINGINDICES_INTERFACE_HPP
...
namespace Universe
{
	...
	class AccessDataUsingIndices_Interface
	{
	public:


		// Create a type definition for this object
		using SelfType = AccessDataUsingIndices_Interface< AnyType >;
		...
		//		They will come
		//
		inline AccessDataUsingIndices_Interface() = default;
		...
		//		They will come
		//
		inline AccessDataUsingIndices_Interface( const SelfType& other ) = default;
		...
		//      Tome
		//
		inline AccessDataUsingIndices_Interface( SelfType&& other ) = default;
		...
		//		They will come
		//
		virtual ~AccessDataUsingIndices_Interface() = default;


		// The following methods are interface that each inherting object will have to implement :
		...
		//  Description :
		//
		//      Use this method to get an handle that can be used to obtain information on the state of the instance
		//
		//  Required arguments :
		//
		//		User information needed :
		...
		//  Return value :
		//
		//		An handle that can be used to obtain information on the state of the instance
		//
		//  Expectations :
		//
		//		NONE
		...
		//  Description :
		//
		//      Use this method to get the largest index possible for the instance, then the range of indices is - [0, Size - 1]
		//
		//  Required arguments :
		//
		//		User information needed :
		...
		//  Return value :
		//
		//		The largest index possible for the instance
		//
		//  Expectations :
		//
		//		NONE
		...
		//  Description :
		//
		//      Use this operator to get a reference to the data associated with the index
		//
		//  Required arguments :
		//
		//      User information needed :
		//			index - an number within the possible range of the instance
		//
		//      Information returned to the user :
		//
		//			NONE
		...
		//  Return value :
		//
		//		A reference to the data associated with the index
		//
		//  Expectations :
		//
		//		1. The given index is in the possible range of the instance
		//		2. 
		//
		//  Possi :
		//
		//		They will come
		//
		virtual AnyType& operator[]( UnsignedInteger64bits index ) = 0;
		...
		//  Description :
		//
		//      Use this operator to get a constant reference to the data associated with the index. This version is for constant instances to allow
		//		only reading the data within them
		//
		//  Required arguments :
		//
		//      User information needed :
		...
		//  Return value :
		//
		//		A constant reference to the data associated with the index
		//
		//  Expectations :
		//
		//		1. The given index is in the possible range of the instance
		...
		//		They will come
		//
		virtual const AnyType& operator[]( UnsignedInteger64bits index ) const = 0;
...
#endif  // ACCESSDATAUSINGINDICES_INTERFACE_HPP
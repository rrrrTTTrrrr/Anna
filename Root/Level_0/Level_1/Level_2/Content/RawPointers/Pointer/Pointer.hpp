...
namespace Universe
{
    ...
    public:
		...
		//		5. State
		//
		ObjectInfrastructure_ForInheritance_MACRO( Pointer< Type > )
...
// **********************************************************   INLINE AND TEMPLATE FRIEND FUNCTIONS IMPLEMENTATION   ***********************************************************
    ...
    {
		// Each method that interacts with the user directly needs to ensure that the given data is valid
    	AssertInstanceIsReady_MACRO( pointer )
	...
	DEBUG_TOOL(
		...
		void Pointer< Type >::Test()
		{
            ...
            *testPointer_1 = 8889;
            ...
            Assert_Test_MACRO( ( *testPointer_1 == 8889 ) );
            ...
            Assert_Test_MACRO( ( testPointer_1 == testPointer_2 ) );

            // Check that copy constructor and the non comparison operator work
            Assert_Test_MACRO( ( testPointer_1 != testPointer_2 ) == false );
            ...
            Assert_Test_MACRO( ( ( testPointer_3[0] == 7 ) && ( testPointer_3[1] == 8 ) && ( testPointer_3[2] == 9 ) &&
            ...
            Assert_Test_MACRO( testPointer_3[4] == *additionPointerResult );

            // Check that the operator worked well
            Assert_Test_MACRO( ( testPointer_3[4] == *( testPointer_3 + 4 ) ) );
            
            // Operator addition
            auto subtractionPointerResult = testPointer_3 - 4;

            // Check that the operator worked well
            Assert_Test_MACRO( *( testPointer_3.member_pointer - 4 ) == *subtractionPointerResult );

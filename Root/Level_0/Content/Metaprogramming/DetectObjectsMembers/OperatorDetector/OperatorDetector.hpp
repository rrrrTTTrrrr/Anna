#ifndef OPERATORDETECTOR_HPP
#define OPERATORDETECTOR_HPP
...
namespace Universe
{
    ...
    #define CreateOperatorDetector( OperatorName, OperatorTextReprsentation )                                                                                                                                                    														\
		...
		/* Template Class Information :																																																													\
		  ...
		  Purpose :																																																																		\
																																																																						\
				Use this object to detect if an object contains a specific operator. The signature of the operator is not important, only if the operator 																																\
				exist or not																																																															\
																																																																						\
		  Description : 																																																																\
		 																																																																				\
		  ...
		  Possible errors : 																																																															\
				...
				Too many to count */ 																																																													\
																																																																						\
		template< typename ObjectToDetectOperatorInsideType > 																																																							\
		class OperatorDetector_ ## OperatorName NotForInheritance 																																																						\
		{ 																																																																				\
		public:																																																																			\
																																																																						\
																																																																						\
			...
			using ObjectType = OperatorDetector_ ## OperatorName< ObjectToDetectOperatorInsideType >;																																													\
																																																																						\
	        ...
	        /* Method Information : 																																																													\
	          ...
	          Description : 																																																															\
	         																																																																			\
	              Use this operator to perform implicit conversion when possible, between this object and the static constant expression value inside it 																																\
	         																																																																			\
	          Required arguments :																																																														\
																																																																						\	        
	              User information needed :																																																												\
	          ...
	          Return value :																																																															\
																																																																						\	        
	              It is not explictly written but a copy of the static constant expression value inside this object will be returned 																																					\
																																																																						\	        
	          Expectations :																																																															\
																																																																						\	        
	              NONE 																																																																	\
	        ...
	        /* Method Information : 																																																													\
	          ...
	          Possible errors :																																																															\
	              ...
	              They will come */																																																														\
																																																																						\
	        constexpr static Boolean Value(); 																																																											\
	        																																																																			\
	        																																																																			\
		private:																																																																		\
																																																																						\
	        ...
	        DisableCopyAndMove_MACRO( OperatorDetector_ ## OperatorName ) 																																																				\
	        																																																																			\
	        																																																																			\
	    ...
	    /* Method Information :																																																															\
	      ...
	      Possible errors : 																																																															\
	          ...
	          They will come */ 																																																														\
	     																																																																				\
	    template< typename ObjectToDetectOperatorInsideType > 																																																							\
	    constexpr OperatorDetector_ ## OperatorName< ObjectToDetectOperatorInsideType >::operator Boolean() const 																																										\
	    { 																																																																				\
	    ...
	    /* Method Information :																																																															\
	      ...
	      Possible errors :																																																																\
	          ...
	          They will come */ 																																																														\
	    																																																																				\
	    template< typename ObjectToDetectOperatorInsideType > 																																																							\
	    constexpr Boolean OperatorDetector_ ## OperatorName< ObjectToDetectOperatorInsideType >::Value() 																																												\
	    {																																																																				\
	    	/* Return the constant expression value that store if the operator exist or not */ 																																															\
	    	return ( member_containsOperatorOrNot ); 																																																									\
	    }
...
// ************************************************************************************************************************************************************************** //
		...
		public:
			...
			// Create a type definition for the object itself
			using ObjectType = OperatorDetector_RoundBrackets< ObjectToDetectOperatorInsideType >;
		...
		private:
	        ...
	        // Disable all copy and move related methods												
	        DisableCopyAndMove_MACRO( OperatorDetector_RoundBrackets )																		
...
//  **************************************************************  TEMPLATE OR INLINE OPERATORS IMPLEMENTATION   *************************************************************** //
	    ...
	    //
	    template< typename ObjectToDetectOperatorInsideType >
	    constexpr OperatorDetector_RoundBrackets< ObjectToDetectOperatorInsideType >::operator Boolean() const
	    {
	    	// Return the constant expression value that store if the operator exist or not
	    	return ( member_containsOperatorOrNot );
	    }
...
//  ***********************************************************   TEMPLATE OR INLINE STATIC METHODS IMPLEMENTATION   ************************************************************ //
	    ...
	    //
	    template< typename ObjectToDetectOperatorInsideType >
	    constexpr Boolean OperatorDetector_RoundBrackets< ObjectToDetectOperatorInsideType >::Value()
	    {
	    	// Return the constant expression value that store if the operator exist or not
	    	return ( member_containsOperatorOrNot );
	    }
...
// ************************************************************************************************************************************************************************** //
		...
		public:
			...
			// Create a type definition for the object itself
			using ObjectType = OperatorDetector_SquareBrackets< ObjectToDetectOperatorInsideType >;
		...
		private:
	        ...
	        // Disable all copy and move related methods												
	        DisableCopyAndMove_MACRO( OperatorDetector_SquareBrackets )																		
...
//  **************************************************************  TEMPLATE OR INLINE OPERATORS IMPLEMENTATION   *************************************************************** //
	    ...
	    //
	    template< typename ObjectToDetectOperatorInsideType >
	    constexpr OperatorDetector_SquareBrackets< ObjectToDetectOperatorInsideType >::operator Boolean() const
	    {
	    	// Return the constant expression value that store if the operator exist or not
	    	return ( member_containsOperatorOrNot );
	    }
...
//  ***********************************************************   TEMPLATE OR INLINE STATIC METHODS IMPLEMENTATION   ************************************************************ //
	    ...
	    //
	    template< typename ObjectToDetectOperatorInsideType >
	    constexpr Boolean OperatorDetector_SquareBrackets< ObjectToDetectOperatorInsideType >::Value()
	    {
	    	// Return the constant expression value that store if the operator exist or not
	    	return ( member_containsOperatorOrNot );
	    }
...
// ************************************************************************************************************************************************************************** //
		...
		public:
			...
			// Create a type definition for the object itself
			using ObjectType = OperatorDetector_BitwiseNot< ObjectToDetectOperatorInsideType >;
		...
		private:
	        ...
	        // Disable all copy and move related methods												
	        DisableCopyAndMove_MACRO( OperatorDetector_BitwiseNot )																		
...
//  **************************************************************  TEMPLATE OR INLINE OPERATORS IMPLEMENTATION   *************************************************************** //
	    ...
	    //
	    template< typename ObjectToDetectOperatorInsideType >
	    constexpr OperatorDetector_BitwiseNot< ObjectToDetectOperatorInsideType >::operator Boolean() const
	    {
	    	// Return the constant expression value that store if the operator exist or not
	    	return ( member_containsOperatorOrNot );
	    }
...
//  ***********************************************************   TEMPLATE OR INLINE STATIC METHODS IMPLEMENTATION   ************************************************************ //
	    ...
	    //
	    template< typename ObjectToDetectOperatorInsideType >
	    constexpr Boolean OperatorDetector_BitwiseNot< ObjectToDetectOperatorInsideType >::Value()
	    {
	    	// Return the constant expression value that store if the operator exist or not
	    	return ( member_containsOperatorOrNot );
	    }
...
// ************************************************************************************************************************************************************************** //
		...
		public:
			...
			// Create a type definition for the object itself
			using ObjectType = OperatorDetector_LogicalNot< ObjectToDetectOperatorInsideType >;
		...
		private:
	        ...
	        // Disable all copy and move related methods												
	        DisableCopyAndMove_MACRO( OperatorDetector_LogicalNot )																		
...
//  **************************************************************  TEMPLATE OR INLINE OPERATORS IMPLEMENTATION   *************************************************************** //
	    ...
	    //
	    template< typename ObjectToDetectOperatorInsideType >
	    constexpr OperatorDetector_LogicalNot< ObjectToDetectOperatorInsideType >::operator Boolean() const
	    {
	    	// Return the constant expression value that store if the operator exist or not
	    	return ( member_containsOperatorOrNot );
	    }
...
//  ***********************************************************   TEMPLATE OR INLINE STATIC METHODS IMPLEMENTATION   ************************************************************ //
	    ...
	    //
	    template< typename ObjectToDetectOperatorInsideType >
	    constexpr Boolean OperatorDetector_LogicalNot< ObjectToDetectOperatorInsideType >::Value()
	    {
	    	// Return the constant expression value that store if the operator exist or not
	    	return ( member_containsOperatorOrNot );
	    }
...
// ************************************************************************************************************************************************************************** //
		...
		public:
			...
			// Create a type definition for the object itself
			using ObjectType = OperatorDetector_StructureDereference< ObjectToDetectOperatorInsideType >;
		...
		private:
	        ...
	        // Disable all copy and move related methods												
	        DisableCopyAndMove_MACRO( OperatorDetector_StructureDereference )																		
...
//  **************************************************************  TEMPLATE OR INLINE OPERATORS IMPLEMENTATION   *************************************************************** //
	    ...
	    //
	    template< typename ObjectToDetectOperatorInsideType >
	    constexpr OperatorDetector_StructureDereference< ObjectToDetectOperatorInsideType >::operator Boolean() const
	    {
	    	// Return the constant expression value that store if the operator exist or not
	    	return ( member_containsOperatorOrNot );
	    }
...
//  ***********************************************************   TEMPLATE OR INLINE STATIC METHODS IMPLEMENTATION   ************************************************************ //
	    ...
	    //
	    template< typename ObjectToDetectOperatorInsideType >
	    constexpr Boolean OperatorDetector_StructureDereference< ObjectToDetectOperatorInsideType >::Value()
	    {
	    	// Return the constant expression value that store if the operator exist or not
	    	return ( member_containsOperatorOrNot );
	    }

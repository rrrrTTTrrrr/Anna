#ifndef MEMBERDETECTOR_HPP
#define MEMBERDETECTOR_HPP
...
namespace Universe
{
    ...
    // This macro should be used to create member detectors. The object needs to know what is the name of the member to detect in the templte type object,
    ...
    // to be detected.
    //
    // For example if a member with the name 'Teeth' needs to be detected, the syntax will look :
    //
    ...
    #define CreateMemberDetector( MemberName )                                                                                                                                                      																					\
		...
		/* Template Class Information :																																																													\
		  ...
		  Purpose :																																																																		\
																																																																						\
				Use this object to detect if an object contains a member with a specific name. The type of the member for data members and the return 																																	\
				type and argumetns types for methods is not important, only if a member with the specified name exist or not 																																							\
		 																																																																				\
		  Description : 																																																																\
		 																																																																				\
				...
				3. Template arguments : 																																																												\
		 																																																																				\
					1. ObjectToDetectMemberNameInsideType - the type of the object that a member with the required name needs to be detected in  																																		\
																																																																						\
		  Expectations :																																																																\
																																																																						\
				NONE 																																																																	\
		...
		private:																																																																		\
	        ...
	        DisableCopyAndMove_MACRO( MemberDetector_ ## MemberName ) 																																																					\
	        																																																																			\
	        																																																																			\
			...
			public: 																																																																	\
																																																																						\
				SignedInteger32bits MemberName; 																																																										\
 																																																																						\
			}; 																																																																			\
 																																																																						\
			...
			/* Method Information :																																																														\
			  ...
			  Description :																																																																\
																																																																						\		
					This method will be used to notify that the given template type object does not contain a member with the given name 																																				\
																																																																						\		
			  Required arguments :																																																														\
																																																																						\		
			      User information needed :																																																												\
			  ...
			  Return value :																																																															\
																																																																						\		
			      A reference to 'DoesNotContainMemberWithTheName' 																																																						\
																																																																						\		
			  Expectations :																																																															\
																																																																						\		
					NONE 																																																																\
			...
			static DoesNotContainMemberWithTheName& UseThisToCheckIfTheObjectContainMemberWithTheName( decltype( ObjectToCreateAmbiguityInCaseMemberWithTheNameDoesExistType::MemberName )* );																							\
																																																																						\
																																																																						\
			/* Method Information :																																																														\
																																																																						\		
			  Description :																																																																\
																																																																						\		
					This method will be used to notify that the given template type object does contain a member with the given name 																																					\
																																																																						\		
			  Required arguments :																																																														\
																																																																						\		
			      User information needed :																																																												\

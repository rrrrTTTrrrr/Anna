#ifndef TYPECHECK_CONSTANTANDVOLATILE_RVALUEREFERENCE_HPP
#define TYPECHECK_CONSTANTANDVOLATILE_RVALUEREFERENCE_HPP
...
namespace Universe
{
    ...
    //  Purpose :
    //
    //      Use this object to provide a type check. In general If the given type is declared as constant and volatile rvalue reference '&&', this object 
    ...
    //      and volatile rvalue reference types
    //
    //  Description :
    //
...
#endif  // TYPECHECK_CONSTANTANDVOLATILE_RVALUEREFERENCE_HPP
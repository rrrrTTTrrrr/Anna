#ifndef ASSERTCONDITIONSONPARAMETERPACK_AND__HPP
#define ASSERTCONDITIONSONPARAMETERPACK_AND__HPP
...
namespace Universe
{
	...
	class AssertConditionsOnParameterPack_AND : public IntegralConstant< Boolean, true >
	{
	private:


        // Disable all default generated methods - constructor, destructor, copy constructor, assignment operator, move constructor and move assignment operator
        NoInstances_MACRO( AssertConditionsOnParameterPack_AND )


	};  //  Class AssertConditionsOnParameterPack_AND
...
// ************************************************************************************************************************************************************************** //
	...
	class AssertConditionsOnParameterPack_AND< Condition, Conditions... > : public ChooseBetweenTwoTypes< Condition::Result(), AssertConditionsOnParameterPack_AND< Conditions... >, IntegralConstant< Boolean, false > >::Type
	{
	private:
...
// ************************************************************************************************************************************************************************** //
    ...
    using DoesParameterPackContainAllConstantTypes = AssertConditionsOnParameterPack_AND< TypeCheck_Constant< ParameterPack >... >;


    // Use this type definition to check if a parameter pack has all types declared as references
    template< typename... ParameterPack >
    using DoesParameterPackContainAllReferenceTypes = AssertConditionsOnParameterPack_AND< TypeCheck_Reference< ParameterPack >... >;


    // Use this type definition to check if a parameter pack has all types declared as lvalue references
    template< typename... ParameterPack >
    using DoesParameterPackContainAllLvalueReferenceTypes = AssertConditionsOnParameterPack_AND< TypeCheck_LvalueReference< ParameterPack >... >;


	// Use this type definition to check if all the types of the parameter pack has default constructor
    template< typename... ParameterPack >
    using DoesParameterPackContainAllTypesWithDefaultConstructor = AssertConditionsOnParameterPack_AND< TypeCheck_DefaultConstructible< ParameterPack >... >;
...
#endif  // ASSERTCONDITIONSONPARAMETERPACK_AND__HPP
#ifndef ASSERTCONDITIONSONPARAMETERPACK_OR__HPP
#define ASSERTCONDITIONSONPARAMETERPACK_OR__HPP
...
#include "../ChooseBetweenTwoTypes/ChooseBetweenTwoTypes.hpp"  //  Class ChooseBetweenTwoTypes
#include "../TypeCheck/Constant/TypeCheck_Constant/TypeCheck_Constant.hpp"  //  Class TypeCheck_Constant
#include "../TypeCheck/Reference/TypeCheck_Reference/TypeCheck_Reference.hpp"  //  Class TypeCheck_Reference
#include "../TypeCheck/Reference/TypeCheck_LvalueReference/TypeCheck_LvalueReference.hpp"  //  Class TypeCheck_LvalueReference
#include "../TypeCheck/Reference/TypeCheck_NonConstant_LvalueReference/TypeCheck_NonConstant_LvalueReference.hpp"  //  Class TypeCheck_NonConstant_LvalueReference
#include "../TypeCheck/DefaultConstructible/TypeCheck_DefaultConstructible/TypeCheck_DefaultConstructible.hpp"  //  Class TypeCheck_DefaultConstructible
...
namespace Universe
{
	...
	class AssertConditionsOnParameterPack_OR : public IntegralConstant< Boolean, false >
	{
	private:


        // Disable all default generated methods - constructor, destructor, copy constructor, assignment operator, move constructor and move assignment operator
        NoInstances_MACRO( AssertConditionsOnParameterPack_OR )


	};  //  Class AssertConditionsOnParameterPack_OR
...
// ************************************************************************************************************************************************************************** //
	...
	class AssertConditionsOnParameterPack_OR< Condition, Conditions... > : public ChooseBetweenTwoTypes< Condition::Result(), IntegralConstant< Boolean, true >, AssertConditionsOnParameterPack_OR< Conditions... > >::Type
	{
	private:
...
// ************************************************************************************************************************************************************************** //
    ...
    using DoesParameterPackContainAtLeastOneConstantType = AssertConditionsOnParameterPack_OR< TypeCheck_Constant< ParameterPack >... >;


    // Use this type definition to check if a parameter pack has at least one type declared as reference
    template< typename... ParameterPack >
    using DoesParameterPackContainAtLeastOneReferenceType = AssertConditionsOnParameterPack_OR< TypeCheck_Reference< ParameterPack >... >;


	// Use this type definition to check if a parameter pack has at least one type declared as lvalue reference
    template< typename... ParameterPack >
    using DoesParameterPackContainAtLeastOneLvalueReferenceType = AssertConditionsOnParameterPack_OR< TypeCheck_LvalueReference< ParameterPack >... >;


	// Use this type definition to check if none of the parameter pack types is a non constant lvalue reference
    template< typename... ParameterPack >
    using DoesParameterPackContainAtLeastOneNonConstantLvalueReferenceTypes = AssertConditionsOnParameterPack_OR< TypeCheck_NonConstant_LvalueReference< ParameterPack >... >;


	// Use this type definition to check if a parameter pack has at least one type that does not contain a default constructor
    template< typename... ParameterPack >
    using DoesParameterPackContainAtLeastOneTypeWithoutDefaultConstructor = AssertConditionsOnParameterPack_OR< TypeCheck_DefaultConstructible< ParameterPack >... >;
...
#endif  // ASSERTCONDITIONSONPARAMETERPACK_OR__HPP
#ifndef PERFORMACTIONACCORDINGTOTYPE_HPP
#define PERFORMACTIONACCORDINGTOTYPE_HPP


#include "../../../CodingLanguages/C++/LanguageFeatures/C++_LanguageFeatures.hpp"  //  Macro DEBUG_ONLY, Macro COMMA
#include "../../CommonFunctionality/SubstitutionFailureIsNotAnError/ProvideTypeOnlyIfAssertionIsTrue/ProvideTypeOnlyIfAssertionIsTrue.hpp"  //  Class ProvideTypeOnlyIfAssertionIsTrue
#include "../TypeCheck/BuiltIn/TypeCheck_BuiltInType/TypeCheck_BuiltInType.hpp"  //  Class TypeCheck_BuiltInType
...
namespace Universe
{
	...
	//		Too many to count
	//
	class PerformActionAccordingToType
	{
	public:


		// Create a type definition for this object
		using SelfType = PerformActionAccordingToType;
		...
		static inline typename ProvideTypeOnlyIfAssertionIsTrue< TypeCheck_BuiltInType< AnyType >::Result() == true >::Type Reset( AnyType& instance );
		...
		//
		template< typename AnyType >
		static inline typename ProvideTypeOnlyIfAssertionIsTrue< TypeCheck_BuiltInType< AnyType >::Result() == false >::Type Reset( AnyType& instance );
		...
		//
		template< typename AnyType >
		static inline typename ProvideTypeOnlyIfAssertionIsTrue< TypeCheck_BuiltInType< AnyType >::Result() == true, AnyType >::Type GetDefaultInstance();
		...
		//
		template< typename AnyType >
		static inline typename ProvideTypeOnlyIfAssertionIsTrue< TypeCheck_BuiltInType< AnyType >::Result() == false, AnyType >::Type GetDefaultInstance();
	...
	private:
		...
		NoInstances_MACRO( PerformActionAccordingToType )
...
//  ***********************************************************   TEMPLATE OR INLINE STATIC METHODS IMPLEMENTATION   ************************************************************
		...
		//
		template< typename AnyType >
		inline typename ProvideTypeOnlyIfAssertionIsTrue< TypeCheck_BuiltInType< AnyType >::Result() == true >::Type PerformActionAccordingToType::Reset( AnyType& instance )
		{
		...
		//
		template< typename AnyType >
		inline typename ProvideTypeOnlyIfAssertionIsTrue< TypeCheck_BuiltInType< AnyType >::Result() == false >::Type PerformActionAccordingToType::Reset( AnyType& instance )
		{
		...
		//
		template< typename AnyType >
		inline typename ProvideTypeOnlyIfAssertionIsTrue< TypeCheck_BuiltInType< AnyType >::Result() == true, AnyType >::Type PerformActionAccordingToType::GetDefaultInstance()
		{
			// The template type is built in type
		...
		//
		template< typename AnyType >
		inline typename ProvideTypeOnlyIfAssertionIsTrue< TypeCheck_BuiltInType< AnyType >::Result() == false, AnyType >::Type PerformActionAccordingToType::GetDefaultInstance()
		{
			// The template type is not a built in type
...
#endif  // PERFORMACTIONACCORDINGTOTYPE_HPP
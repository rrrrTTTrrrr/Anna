...
namespace Universe
{
	...
	//  Purpose :
	//
	//		Use this object to store type definitions of the template arguments provided. The point is that the first argument is used to tell
	...
	class TypesHolder NotForInheritance
	{
	public:


        // Make a recurssive call the will end with a type definition of the required template argument
        using Type = typename TypesHolder< RequiredTemplateArgumentIndex - 1, TemplateArguments... >::Type;
	...
	private:
        ...
        DisableCopyAndMove_MACRO( TypesHolder )
...
// ************************************************************************************************************************************************************************** //
	...
	class TypesHolder< 0, ExposedType, TemplateArguments... > NotForInheritance
	{
	public:

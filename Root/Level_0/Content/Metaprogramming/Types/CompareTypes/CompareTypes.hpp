#ifndef  COMPARETYPES_HPP
#define  COMPARETYPES_HPP
...
namespace Universe
{
    ...
    class CompareTypes : public IntegralConstant< Boolean, CompareTypes< FirstType, SecondType >::Result() && CompareTypes< SecondType, Types... >::Result() >
    {
    private :


        // Disable all default generated methods - constructor, destructor, copy constructor, assignment operator, move constructor and move assignment operator
        NoInstances_MACRO( CompareTypes )
...
// ************************************************************************************************************************************************************************** //
    ...
    class CompareTypes< FirstType, SecondType > : public IntegralConstant< Boolean, false >
    {
    private :
...
// ************************************************************************************************************************************************************************** //
    ...
    class CompareTypes< Type, Type > : public IntegralConstant< Boolean, true >
    {
    private :

#ifndef INCREMENTINGINTEGERSEQUENCEGENERATOR_HPP
#define INCREMENTINGINTEGERSEQUENCEGENERATOR_HPP


#include "../../../../CodingLanguages/C++/LanguageFeatures/C++_LanguageFeatures.hpp"  //  Macro DEBUG_ONLY, Macro COMMA, Macro CompileTimeAssert
#include "../IncrementingIntegerSequenceHolder/IncrementingIntegerSequenceHolder.hpp"  //  Class IncrementingIntegerSequenceHolder
...
namespace Universe
{
	...
	private:
        ...
        DisableCopyAndMove_MACRO( IncrementingIntegerSequenceGenerator )
...
#endif  // INCREMENTINGINTEGERSEQUENCEGENERATOR_HPP
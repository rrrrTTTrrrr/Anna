#ifndef  PROVIDETYPEONLYIFASSERTIONISTRUE_HPP
#define  PROVIDETYPEONLYIFASSERTIONISTRUE_HPP
...
namespace Universe
{
	...
	//		Too many to count
	//
	template< Boolean ExpressionResult, typename TYPE = void >
	...
	private:
        ...
        NoInstances_MACRO( ProvideTypeOnlyIfAssertionIsTrue )
...
// ************************************************************************************************************************************************************************** //
    ...
    class ProvideTypeOnlyIfAssertionIsTrue< false, TYPE > NotForInheritance
    {
    private:
...
#endif  // PROVIDETYPEONLYIFASSERTIONISTRUE_HPP
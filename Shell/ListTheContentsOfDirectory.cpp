...
namespace Universe
{
    ...
    inline bool DoesDataWaitOnStandardInput() throw()
    {
    	...
    	// Set inside the file descriptor filed in pollfd structure the standard input file descriptor ( 0 )
    	...
    	{
    		// Check the reason for the failure and if it is not becuase of signal interrupt throw an Exception

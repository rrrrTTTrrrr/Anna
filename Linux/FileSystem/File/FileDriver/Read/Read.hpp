...
#include "../BaseFileDriver/BaseFileDriver.hpp"  //  Class BaseFileDriver
...
namespace Universe
{
    ...
    namespace FileSystem
    {
    	...
    	//
    	//
    	class Read : public BaseFileDriver
        {
        public:
            ...
            //      They will come
            //
            Read( const Encoding::UnicodeString& fileAbsolutePath ) throw( Exception );
    		...
    		//		They will come
    		//
    		inline Read( const Read& other ) throw( Exception );
    		...
    		//		They will come
    		//
    		inline Read& operator=( const Read& other ) throw( Exception );
    		...
    		//		They will come
    		//
    		inline Read( Read&& other ) throw( Exception );
    		...
    		//		They will come
    		//
    		inline Read& operator=( Read&& other ) throw( Exception );
...
//	****************************************************************   END PART OF DECLRATIONS, IMPLMENTATION TIME   ************************************************************
    	...
    	//		They will come
    	//
    	Read::Read( const Encoding::UnicodeString& fileAbsolutePath ) throw( Exception ) :
        BaseFileDriver( fileAbsolutePath, O_RDONLY, S_IRUSR )
        {}
    	...
    	//		They will come
    	//
    	Read::Read( const Read& other ) throw( Exception ) :
        ...
        //    They will come
        //
        inline Read& Read::operator=( const Read& other ) throw( Exception )
        {
    	...
    	//		They will come
    	//
    	Read::Read( Read&& other ) throw( Exception ) :
        BaseFileDriver( other )
    	{}
        ...
        //      They will come
        //
        inline Read& Read::operator=( Read&& other ) throw( Exception )
        {

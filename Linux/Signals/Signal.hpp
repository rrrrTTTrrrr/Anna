...
namespace Universe
{
    ...
    namespace Linux
    {
    	...
    	//
    	//
    	template< typename SignalHanlderSignature >
    	class Signal
    	{
    	public:
    		...
    		//		They will come
    		//
    		inline Signal( const Signal< SignalHanlderSignature >& other );
    		...
    		//		They will come
    		//
    		inline Signal< SignalHanlderSignature >& operator=( const Signal< SignalHanlderSignature >& other );
    		...
    		//		They will come
    		//
    		inline Signal( Signal< SignalHanlderSignature >&& other );
    		...
    		//		They will come
    		//
    		inline Signal< SignalHanlderSignature >& operator=( Signal< SignalHanlderSignature >&& other );
    		...
    		//      They will come
    		//
    		static void Swap( Signal< SignalHanlderSignature >& firstObject, Signal< SignalHanlderSignature >& secondObject ) throw();
    		...
    		//		They will come
    		//
    		bool operator==( const Signal< SignalHanlderSignature >& other ) const;
    		...
    		//		They will come
    		//
    		inline bool operator!=( const Signal< SignalHanlderSignature >& other ) const;
...
//	*******************************************************   END PART OF DECLRATIONS, PUBLIC METHODS IMPLMENTATION TIME   *******************************************************
    	...
    	//
    	template< typename SignalHanlderSignature >
    	inline Signal< SignalHanlderSignature >::Signal( SignedInteger32bits signalNumber, SignalHanlderSignature signalHandler ) throw() :
    	{
            // This structure will 
        }
    	...
    	//
    	template< typename SignalHanlderSignature >
    	Signal< SignalHanlderSignature >::Signal() :
    	{}
    	...
    	//
    	template< typename SignalHanlderSignature >
    	inline Signal< SignalHanlderSignature >::Signal( const Signal< SignalHanlderSignature >& other ) :
    	{}
    	...
    	//
    	template< typename SignalHanlderSignature >
    	inline Signal< SignalHanlderSignature >& Signal< SignalHanlderSignature >::operator=( const Signal< SignalHanlderSignature >& other )
    	{
    		// Create a copy of the other instance
    		Signal< SignalHanlderSignature > temporaryObject( other );
    	...
    	//
    	template< typename SignalHanlderSignature >
    	inline Signal< SignalHanlderSignature >::Signal( Signal< SignalHanlderSignature >&& other ) :
    	Signal< SignalHanlderSignature >()
    	{
    	...
    	//
    	template< typename SignalHanlderSignature >
    	inline Signal< SignalHanlderSignature >& Signal< SignalHanlderSignature >::operator=( Signal< SignalHanlderSignature >&& other )
    	{
    	    // Create a default constructed instance
    	    Signal< SignalHanlderSignature > temporaryObject;
    	...
    	//
    	template< typename SignalHanlderSignature >
    	void Signal< SignalHanlderSignature >::Swap( Signal< SignalHanlderSignature >& firstObject, Signal< SignalHanlderSignature >& secondObject ) throw()
    	{}
    	...
    	//
    	template< typename SignalHanlderSignature >
    	void Signal< SignalHanlderSignature >::Delete() throw()
    	{
    	...
    	//
    	template< typename SignalHanlderSignature >
    	inline Signal< SignalHanlderSignature >::~Signal() throw()
    	{
           	// Delete the object resources
           	Delete();
    	}
    	...
    	//
    	template< typename SignalHanlderSignature >
    	inline void Signal< SignalHanlderSignature >::SetToDefaultState()
    	{
    	    // Create a default constructed instance
    	    Signal< SignalHanlderSignature > temporaryObject;
    	...
    	//
    	template< typename SignalHanlderSignature >
    	inline bool Signal< SignalHanlderSignature >::DefaultState() const
    	{
    	...
    	//
    	template< typename SignalHanlderSignature >
    	inline void Signal< SignalHanlderSignature >::DeleteResourcesAndSetToDefaultState()
    	{
...
//  **************************************************************  TEMPLATE OR INLINE OPERATORS IMPLEMENTATION   ***************************************************************
    	...
    	//
    	template< typename SignalHanlderSignature >
    	bool Signal< SignalHanlderSignature >::operator==( const Signal< SignalHanlderSignature >& other ) const
    	{}
    	...
    	//
    	template< typename SignalHanlderSignature >
    	inline bool Signal< SignalHanlderSignature >::operator!=( const Signal< SignalHanlderSignature >& other ) const
    	{
...
// *********************************************************************************   TESTING   ********************************************************************************
    	...
    	DEBUG_TOOL(
    		...
    		//
    		template< typename SignalHanlderSignature >
    		void < SignalHanlderSignature >::Test() throw( std::bad_alloc, ErrorHandling::Exception )
    		{}

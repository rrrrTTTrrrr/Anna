#ifndef  SIGNALACTION_HPP
#define  SIGNALACTION_HPP
...
namespace Universe
{
    ...
    namespace Linux
    {
    	...
    	public:
    		...
    		//		They will come
    		//
    		inline SignalAction( const SignalAction& other ) throw();
    		...
    		//		They will come
    		//
    		inline SignalAction& operator=( const SignalAction& other ) throw();
    		...
    		//		They will come
    		//
    		inline SignalAction( SignalAction&& other ) throw();
    		...
    		//		They will come
    		//
    		inline SignalAction& operator=( SignalAction&& other ) throw();
    		...
    		//      They will come
    		//
    		static void Swap( SignalAction& firstObject, SignalAction& secondObject ) throw();
    		...
    		//      2.
    		//
    		inline void DeleteResourcesAndSetToDefaultState() throw();
    		...
    		//		They will come
    		//
    		bool operator==( const SignalAction& other ) const throw();
    		...
    		//		They will come
    		//
    		inline bool operator!=( const SignalAction& other ) const throw();
    	...
    	private:
            ...
            // This structure will store the signal actions
...
//	*******************************************************   END PART OF DECLRATIONS, PUBLIC METHODS IMPLMENTATION TIME   *******************************************************
    	...
    	//		They will come
    	//
    	inline SignalAction::SignalAction() throw() :
    	{
            // Set the structure members to 0
            Memory::Set< struct sigaction >( DataTypes::Pointer< struct sigaction >( &m_signalAction, 1 ), 0 );
        }
    	...
    	//		They will come
    	//
    	SignalAction::SignalAction( void (*signalHandler)( int, siginfo_t*, void* ),  ) throw() :
    	{}
    	...
    	//		They will come
    	//
    	inline SignalAction::SignalAction( const SignalAction& other ) throw() :
    	{}
    	...
    	//		They will come
    	//
    	inline SignalAction& SignalAction::operator=( const SignalAction& other ) throw()
    	{
    		// Create a copy of the other instance
    		SignalAction temporaryObject( other );
    	...
    	//		They will come
    	//
    	inline SignalAction::SignalAction( SignalAction&& other ) throw() :
    	SignalAction()
    	{
    	...
    	//		They will come
    	//
    	inline SignalAction& SignalAction::operator=( SignalAction&& other ) throw()
    	{
    	    // Create a default constructed instance
    	    SignalAction temporaryObject;
    	...
    	//      They will come
    	//
    	void SignalAction::Swap( SignalAction& firstObject, SignalAction& secondObject ) throw()
    	{}
    	...
    	//      They will come
    	//
    	void SignalAction::Delete() throw()
    	{
    	...
    	//	    They will come
    	//
    	inline void SignalAction::SetToDefaultState() throw()
    	{
    	    // Create a default constructed instance
    	    SignalAction temporaryObject;
    	...
    	//		They will come
    	//
    	inline bool SignalAction::DefaultState() const throw()
    	{
    	...
    	//      2.
    	//
    	inline void SignalAction::DeleteResourcesAndSetToDefaultState() throw()
    	{
...
//  **************************************************************  TEMPLATE OR INLINE OPERATORS IMPLEMENTATION   ***************************************************************
    	...
    	//      2. 
    	//
    	bool SignalAction::operator==( const SignalAction& other ) const throw()
    	{}
    	...
    	//      2. 
    	//
    	inline bool SignalAction::operator!=( const SignalAction& other ) const throw()
    	{
